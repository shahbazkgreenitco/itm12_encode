var BulkCheckoutPhase = function(config) {
  var t = this;
  t.config = config;
...
var CheckoutInfoPhase = function(config) {
    var t = this;
    t.config = config;
...
var MyApp = function(config) {
  ...
  t.bulkCheckoutPhase = new BulkCheckoutPhase(config);
  t.checkoutInfoPhase = new CheckoutInfoPhase(config);
