var DeviceCheckFilePhase = function (config) {
    var t = this;
    t.config = config;
    t.form = $("#confirmForm");
...
var DeviceCheckoutInfoPhase = function (config) {
    var t = this;
    t.config = config;
    t.tab = $("section.content").find("#check-out-info-tab");
    t.table = t.tab.find("#tblCheckout");
    ...
    t.initDataTable = function () {
        t.dTbl = t.table.DataTable({
            ...
            order: [[5, "desc"]],
            ajax: {
                url: t.config.bulk_checkout_info,
                type: "POST",
                data: function (d) {
...
var MyApp = function (config) {
    ...
    t.DeviceCheckFilePhase = new DeviceCheckFilePhase(config);
    t.DeviceCheckoutInfoPhase = new DeviceCheckoutInfoPhase(config);
