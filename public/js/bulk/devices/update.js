var BulkUpdatePhase = function (config) {
    var t = this;
    t.config = config;
    t.form = $("#confirmForm");
...
var UpdateInfoPhase = function (config) {
    var t = this;
    t.config = config;
    t.tab = $("section.content").find("#update-info-tab");
    t.table = t.tab.find("#tblUpdate");
...
var MyApp = function (config) {
    ...
    t.BulkUpdatePhase = new BulkUpdatePhase(config);
    t.UpdateInfoPhase = new UpdateInfoPhase(config);
