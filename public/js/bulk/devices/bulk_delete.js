var BulkDeleteFilePhase = function (config) {
    var t = this;
    t.config = config;
    t.form = $("#confirmForm");
...
var DeleteInfoPhase = function (config) {
    var t = this;
    t.config = config;
    t.tab = $("section.content").find("#delete-info-tab");
                    ...
                    render: function (d) {
                        return `
                            <a 
                                ...
                                class="btn dtActbtn"
                                data-toggle="tooltip"
                                title="${t.config.translations.Download_Document || 'Download'}">
...
var MyApp = function (config) {
    ...
    t.BulkDeleteFilePhase = new BulkDeleteFilePhase(config);
    t.DeleteInfoPhase = new DeleteInfoPhase(config);
