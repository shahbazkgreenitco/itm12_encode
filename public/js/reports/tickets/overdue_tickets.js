var MyApp = function(config) {
    ...
    t.filter_non_handler = t.filters.wrapper.find("#filter_non_handler"),
        ...
        reload_sub_category: function() {
          ...
          reload_creator: function () {
            t.filters.creator.select2($.extend({}, select2Opts, {
                ...
                allowClear: true,
                placeholder: "Select the Ticket Creator"
            }));
    ...
    t.cache_filter_values = function() {
        ...
        if (t.filters.ticket_non_handler && t.filters.ticket_non_handler.val() !== 'null' && t.filters.ticket_non_handler.val() !== null) {
            t.config.other_filters.ticket_non_handler = t.filters.ticket_non_handler.val();
        }
    ...
    t.renderList = function(i, d) {
        var fc = "<tr><td class='b5-text'>" + t._s('<a href="' + t.config.url.view_ticket + "/" + d.id + "?b=" + "all-tickets" + '"target="_blank" class="underline">#'+ d.id +'</a>') + "</td><td class='b5-text'>" + t._s('<a href="' + t.config.url.view_ticket + "/" + d.id + "?b=" + "all-tickets" + '"target="_blank" class="underline">'+ d.subject +'</a>') + "</td><td class='b5-text'>" + t._s(d.dept_name) + "</td><td class='b5-text'>" + t._s(d.problem_category) + "</td><td class='b5-text'>" + t._s(d.sub_category) + "</td><td class='b5-text'><div>" + t._s(d.creator) + "</div><div>" + t._s(d.creator_email) + "</div></td><td class='b5-text'>" + t._s(d.create_via) + "</td><td class='b5-text'>" + t._s(d.status) + "</td><td class='b5-text'><div>" + t._s(d.handler_name) + "</div><div>" + t._s(d.handler_email) + "</div></td><td class='b5-text'>" + t._s(d.tat) + "</td><td class='b5-text'>" + t._s(d.ticket_expire_at) + "</td><td class='b5-text'>" + t._s(d.response_sla) + "</td><td class='b5-text'>" + t._s(d.response_at) + "</td><td class='b5-text'>" + t._s(d.response_sla_breach) + "</td><td class='b5-text'>" + t._s(d.workaround_sla) + "</td><td class='b5-text'>" + t._s(d.workaround_at) + "</td><td class='b5-text'>" + t._s(d.workaround_sla_breach) + "</td><td class='b5-text'>" + t._s(d.priority) + "</td><td class='b5-text'>" + t._s(d.created_at_format) + "</td><td class='b5-text'>" + t._s(d.location_name) + "</td><td class='b5-text'>" + t._s(d.ticket_type) + "</td>";
    ...
    t.load = function() {
        var http = $.ajax({
            url: config.url.list_overdue_tickets, 
            type: "POST",
            data: {
    ...
    t.btnClrFilter = function() {
        ...
        // t.filters.from_date.val("");
        // t.filters.to_date.val("");
        t.filters.ticket_type.val("").trigger("change");
        t.filter_non_handler.val("null").trigger("change");
    ...
    t.filters.create_via.select2($.extend({}, select2Opts,{dropdownParent:t.filters.wrapper,placeholder:config.translations.Filter_By_Created_via}));
    ...
    t.filter_non_handler.select2($.extend({}, select2Opts,{dropdownParent: t.filters.wrapper}));
