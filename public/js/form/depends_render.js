...
function getFieldInformation(field) {
    ...
    if (field.is('p') || field.is('address') || field.is('blockquote') || field.is('canvas') || field.is('output') || field.is('h1') || field.is('h2') || field.is('h3')|| field.is('h4')  || field.is('h5') || field.is('h6')) {
