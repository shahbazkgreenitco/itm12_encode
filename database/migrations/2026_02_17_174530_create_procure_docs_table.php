...
return new class extends Migration
{
    ...
    {
        Schema::create('procure_docs', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->boolean('pr_doc_type')->nullable()->default(false)->comment('1 - Supplier Quotation, 2 - Purchase Invoice');
    ...
    {
        Schema::dropIfExists('procure_docs');
    }
};
