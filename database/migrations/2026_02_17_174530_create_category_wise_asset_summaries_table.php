...
return new class extends Migration
{
    ...
    {
        Schema::create('category_wise_asset_summaries', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('category_wise_id')->comment('1-Laptop, 2-Desktop, 3-Other');
            $table->date('date');
    ...
    {
        Schema::dropIfExists('category_wise_asset_summaries');
    }
};
