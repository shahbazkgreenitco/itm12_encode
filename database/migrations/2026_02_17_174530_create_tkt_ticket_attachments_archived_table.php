...
return new class extends Migration
{
    ...
    {
        Schema::create('tkt_ticket_attachments_archived', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedBigInteger('kid')->nullable()->comment('Kanban card ID reference for comment  attacment');
        });
    }
    ...
    {
        Schema::dropIfExists('tkt_ticket_attachments_archived');
    }
};
