...
return new class extends Migration
{
    ...
    {
        Schema::create('tkt_ticket_status_history_archived', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->tinyInteger('tat_changed')->nullable();
    ...
    {
        Schema::dropIfExists('tkt_ticket_status_history_archived');
    }
};
