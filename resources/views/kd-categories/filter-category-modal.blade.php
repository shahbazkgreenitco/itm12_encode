 <div class="amg-modal modal fade" id="categoryFilterModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-xl modal-dialog-centered" style="max-width: 1200px;">
            <div class="modal-content rounded-5 bg-white">
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    <h3 class="modal-title px-4">Category Filter</h3>
                ...
                <div class="modal-body">
                    <div class="row g-3 px-4">
                        <div class="col-12 col-lg-4 my-2 mb-xl-0">
                            <label>{{ trans('config.filter_heading.filter_by_company') }}</label>
                            <select class="form-control" id="filter_by_company" name="filter_by_company"></select>
                        </div>
                      
                        <!-- Department -->
                        <div class="col-12 col-lg-4 my-2 mb-xl-0">
                            <label>{{ trans('config.filter_heading.filter_by_department') }}</label>
                            <select class="form-control" id="filter_by_department" name="filter_by_department" ></select>
                        </div>

                        {{-- parent category --}}
                        <div class="col-12 col-lg-4 my-2 mb-xl-0">
                            <label>{{ trans('config.filter_heading.Filter_By_Parent_Category') }}</label>
                            <select class="form-control" id="filter_by_parent_category" name="filter_by_parent_category[]" multiple></select>
                        </div>

                        {{--  category --}}
                        <div class="col-12 col-lg-4 my-2 mb-xl-0">
                            <label>{{ trans('config.filter_heading.Filter_By_Sub_Category') }}</label>
                            <select class="form-control" id="filter_by_category" name="filter_by_category[]" multiple></select>
                        </div>
