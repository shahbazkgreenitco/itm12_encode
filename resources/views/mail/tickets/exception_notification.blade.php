...
{
    "page_no": "STEN-26",
    "file": "exception_notification.blade.php",
    "versions": [
        {
        "version": "1.0",
        "writer": "Priya Maru",
        "from": "2026-06",
        "reviewer": null,
        "description": "Ticket Conversion Exception Notification Mail"
        },
        {
        "version": "1.1",
        "writer": "Priya Maru",
...
<p style="text-align:left; font-family:'Plus Jakarta Sans', Arial, Helvetica, sans-serif; font-size:14px; color:#333333; margin:0 0 20px 0;">The e-mail has encountered an exception during the ticket conversion process. Please review the details below.</p>
...
<table role="presentation" class="table" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; border-collapse:collapse; margin-top:10px;">
    ...
    <tr>
        ...
        <td align="left" bgcolor="{{ $bg }}" style="{{ $tdBase }} background-color: {{ $bg }}; border:1px solid #dddddd;">{{ $datetime->format('d/m/Y h:i a') }}</td>
    </tr>
    @endif
