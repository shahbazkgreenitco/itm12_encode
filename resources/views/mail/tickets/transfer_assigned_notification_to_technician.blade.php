...
{
    "page_no": "STTAT-26",
    "file": "transfer_assigned_notification_to_technician.blade.php",
    "versions": [
        {
        "version": "1.0",
        "writer": "Priya Maru",
        "from": "2026-06",
        "reviewer": null,
        "description": "Ticket transfer assign notification Mail"
        },
        {
        "version": "1.1",
        ...
        "from": "2026-07",
        "reviewer": null,
        "description": "New modern layout with greeting icon, transfer assigned header, details table, and CTA"
        }
    ]
}
--}}
...
@endphp
    ...
    <!-- Header - Ticket Transfer Assigned -->
    <h1 style="font-size:22px; font-weight:700; color:#1a1a1a; line-height:1.35; margin:0 0 6px 0; font-family:'Inter',Arial,sans-serif;">
        Ticket has been<br>
        <span style="color:{{ $themeColor }};">assigned to you</span>
    </h1>
