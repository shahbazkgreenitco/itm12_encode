{{-- @page-meta
{
    ...
    "versions": [
        ...
        "from": "2026-06",
        "reviewer": null,
        "description": "Task Creation Mail"
        }
    ]
} 
--}}
...
<p>@if($task_creator) Hello {{$task_creator->fullName() }}, @else Hello, @endif </p>

<p style="text-align: left;">We have received task successfully. We will resolve query on desired time.</p>
