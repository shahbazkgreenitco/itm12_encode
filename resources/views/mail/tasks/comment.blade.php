...
<table class="table">
    ...
    @if(!empty($creator) && !empty($creator->fullname()))
        <tr style="background-color: {{ ($rowIndex++ % 2 == 0) ? '#f4f4f4' : '#ffffff' }};">
            <th>Created By</th>
    ...
    @if(!empty($comment->remarks))
        <tr style="background-color: {{ ($rowIndex++ % 2 == 0) ? '#f4f4f4' : '#ffffff' }};">
            <th>Remarks</th>
            <td>{!! CommonHelper::renderTktContent($comment->remarks, $embedded_attachments, true) !!}</td>
        </tr>
    @endif

</table>

<p style="text-align: left;"><strong>New Comment on Task:</strong> #{{ $task->id }}</p>

<p style="text-align: left;"><strong>Commented By:</strong> {{ $comment->changer->fullName() }}</p>

<div style="text-align: left;">{!! CommonHelper::renderTktContent($comment->remarks, $embedded_attachments, true) !!}</div>
