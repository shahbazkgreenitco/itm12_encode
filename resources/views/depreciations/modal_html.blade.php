...
*/
--}}
<div id="depreciationMdl" class="amg-modal modal fade user-mdl-box relevant-ticket-mdl-box" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form id="depreciationForm" name="customFieldForm w-100" method="post" action="#" class="form-horizontal">
            <div class="modal-content rounded-5">

                {{-- modal head --}}
                <div class="modal-header">
                    <h3 class="modal-title px-4" id="locationModalLabel">
                        {{ trans('depreciations.modal.add_depreciation_header') }}
                    </h3>
                            ...
                            <div class="row g-4 px-4">
                                <div class="col-md-6">
                                    <label class="form-label b1-text mb-2">
                                        {{ trans('depreciations.modal.depreciation_name') }} <span
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            placeholder="{{ trans('depreciations.modal.depreciation_name_placeholder') }}"
                                            required>
                                        <div class="field-error">{!! $errors->first('name', '<label class="error"><i class="fa fa-times"></i> :message</label>') !!}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label b1-text mb-2">
                                        {{ trans('depreciations.modal.number_of_months') }} <span
                                            class="required">*</span> </label>
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1"> 
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        ...
                                        <input type="text" name="months" id="months" class="form-control"
                                            placeholder="{{ trans('depreciations.modal.number_of_months_placeholder') }}"
                                            required>
                                        <div class="field-error">{!! $errors->first('months', '<label class="error"><i class="fa fa-times"></i> :message</label>') !!}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
