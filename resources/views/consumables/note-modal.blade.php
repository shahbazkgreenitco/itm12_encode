...
<!-- Modal -->
<div class="modal fade amg-modal user-mdl-box relevant-ticket-mdl-box" id="noteModal" tabindex="-1" aria-labelledby="noteModalLabel"  aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content rounded-5">
            ...
            <div class="modal-body">
                <div class="container-fluid py-3 px-4">
                    <p id="fullNote" class="mb-0"></p>
                </div>
            </div>
            <div class="modal-footer justify-content-end pb-4 py-0 me-3">
                <div class="d-flex">
                    <button type="button" class="amg-btn amg-btn-secondary amg-btn-block amg-btn-md mb-2" data-bs-dismiss="modal">
                        Close
                    </button>
                </div>
            </div>
