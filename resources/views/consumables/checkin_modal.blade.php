...
*/
--}}
<div id="consumable-checkin-mdl" class="amg-modal modal fade consumable-checkin-mdl-box" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <form id="consumable-checkin-mdl-frm" name="consumable-checkin-mdl-frm" method="post" action="#" class="form-horizontal w-100">
            @csrf
            <input type="hidden" name="id" id="id" class="hidden" />
            <div class="modal-content rounded-5">
                <div class="modal-header">
                    <h3 class="modal-title px-4">
                        {{ trans('consumables.consumables_info.modal.checkin_consumable') }}
                    </h3>
                    ...
                    <div class="container-fluid py-3">
                        <div class="row g-4 px-4">
                            <div class="col-md-12 amg-form-field-row">
                                <label for="lblUserName" class="form-label b1-text mb-2">
                                    {{ trans('consumables.consumables_info.modal.checkin_from') }}
                                </label>
                                <div class="input-group">
                                    ...
                                    <label id="lblUserName" class="form-control d-flex align-items-center mb-0"></label>
                                </div>
                            </div>
                            @can('ConsumableScrap')
                                <div class="col-md-12 amg-form-field-row">
                                    <input type="checkbox" name="scrap_qty" id="scrap_qty" class="form-check-input" value="1">
                                    <label for="scrap_qty" class="form-check-label b1-text">
                                        {{ trans('consumables.consumables_info.modal.is_this_scraped') }}
                                    </label>
                                </div>
                            @endcan
                            <div class="col-md-12 amg-form-field-row">
                                <label for="note" class="form-label b1-text mb-2">
                                    {{ trans('consumables.consumables_info.modal.notes') }}
                                </label>
                                <div class="input-group">
                                    ...
                                    <textarea name="note" id="note" class="form-control" placeholder="{{ trans('consumables.consumables_info.modal.notes') }}"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
