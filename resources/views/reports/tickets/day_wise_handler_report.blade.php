...
@section('title', trans("report.day_wise_handler_report"))

@section('content')
    <div class="content" id="content-container">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <h3 class="h3-text mb-0">{{ trans("report.day_wise_handler_report") }}</h3>
            ...
            <div class="container-fluid px-0">
                <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-12">
                                <label class="text-bold note_text">{{ trans("report.note_text") }}</label>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="lgTbl" class="table display app-data-table">
                                    <thead>
                                        <tr>
                                            <th>
                                                <h4 class="b2-text">{{ trans("report.location") }}</h4>
                                            </th>
                                            <th class="amg-table-col-176">
                                                <h4>{{ trans("report.handler") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("report.ticket_assigned") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("report.open_tickets") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("report.resolved_out_of_sla") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("report.resolved_with_in_sla") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("report.rr") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("report.overall_feedback") }}</h4>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="lg">
                        ...
                        <div class="row g-3 px-3">
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <select name="filter_by_date" id="filter_by_date" class="form-select">
                                    ...
                                    <option value="1">{{ trans('custom_report.ticket_created_at') }}</option>
                                </select>
                            </div>
                            ...
                            {{-- Row 1: Ticket Handler, Location --}}
                            <div class="col-lg-6 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans("report.by_ticket_handler") }}
                                </label>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans("report.filter_by_location") }}
                                </label>
...
@push('scripts')
    <script type="text/javascript"
        src="{!! CommonHelper::asset('js/reports/tickets/day_wise_handler_report.js') !!}"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            var config = {};
            config.url = {};
            config.url.list_tickets = "{{ url('reports/tickets/jx-day-wise-handler-report') }}";
            config.url.export_ticket_xls = "{{ url('reports/downloadDayWiseHandlerReport') }}";
            ...
            config.ticket_handlers = {!! json_encode($vd->ticket_handlers) !!};
            ...
            config.translations = {
                ...
                Filter_By_Ticket_Handler: '{{ trans('report.by_ticket_handler') }}',
