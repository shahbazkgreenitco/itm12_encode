...
@section('title', trans("custom_report.tickets_report"))
@section('content')
    <div class="content" id="content-container">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <h3 class="h3-text mb-0">{{ trans("custom_report.tickets_report") }}</h3>
            <div class="d-flex gap-8">
                ...
                <div data-bs-toggle="tooltip" title="{{ trans('service_ticket.sort') }}">
                    <div class="header-icon-btn dropdown sort-buttons" id="srqSortDrop">
                        <span class="sortbtns dir-sort" data-id="7" data-dir="desc">
                            <svg id="sortAscSvg" class="hide" width="18px" height="18px" viewBox="0 0 24 24" fill="none"
                ...
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-download" type="button"
                    data-bs-toggle="tooltip" title="{{ trans('custom_report.download') }}">
                ...
                <div class="card rounded-0">
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-2 mb-1">
                            <div class="col-auto">
                                <select id="pageLimiter"
                                    class="userModulePageLenth amg-table-pagination-dropdown amgTablePageLenth">
                            ...
                            <div>
                                <div class="amg-list-searchbar">
                                    ...
                                    <input type="text"
                                        ...
                                        id="announcement-list-search" placeholder="{{ trans('custom_report.press_enter_with_search') }}">
                                </div>
                            </div>
                        ...
                        <div class="js-user-list-view-panel">
                            <div class="gtable-cover">
                                <table id="lgTbl" class="amg-datatable mytable table table-striped">
                                    <thead>
                                        <tr id="tHeadeRow">
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_id") }}</h4>
                                            </th>
                                            @if(config('app.client') == 'ril' || config('app.client') == 'rolepermission')
                                                <th>
                                                    <h4>{{ trans("custom_report.seat_no") }}</h4>
                                                </th>
                                            @endif
                                            <th class="amg-table-col-176">
                                                <h4>{{ trans("custom_report.department") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.problem_category") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.sub_category") }}</h4>
                                            </th>
                                            <th class="amg-table-col-176">
                                                <h4>{{ trans("custom_report.ticket_created_at") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_pickup_datetime") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_status_changes_top_progress") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_status_changes_to_resolved") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_resolved_by") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.tot_exc_non_work_hr") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.tot_inc_work_hr") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.status") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.tat") }}</h4>
                                            </th>
                                            <th class="amg-table-col-176">
                                                <h4>{{ trans("custom_report.tat_expire_at") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.time_taken_by_res") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_sla_info") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.response_sla_expiry_at") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.response_at") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.response_sla_breach") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.workaround_sla_expiry_at") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.workaround_at") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.workaround_sla_breach") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.no_of_resolver") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.resolver1_info") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.resolver2_info") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.resolver3_info") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_status_on_hold") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_status_on_inprogress") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_status_on_user_waiting") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_status_on_vendor_waiting") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.priority") }}</h4>
                                            </th>
                                            <th class="amg-table-col-176">
                                                <h4>{{ trans("custom_report.location") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.tags") }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans("custom_report.ticket_type") }}</h4>
                                            </th>
                                            @if(in_array(config('app.client'), ["rolepermission", "grdemo", "greenitco"]))
                                                <th>
                                                    <h4>{{ trans("custom_report.total_task") }}</h4>
                                                </th>
                                                <th>
                                                    <h4>{{ trans("custom_report.completed_task") }}</h4>
                                                </th>
                                                <th>
                                                    <h4>{{ trans("custom_report.incompleted_task") }}</h4>
                                                </th>
                                                <th>
                                                    <h4>{{ trans("custom_report.percentage_of_task") }}</h4>
                                                </th>
                                            @endif
                                            @foreach($ticketTypeFields as $field)
                                                <th>
                                                    <h4>{{ $field['fieldName'] }}</h4>
                                                </th>
                                            @endforeach
                                            @foreach($customFieldsFromTable as $field)
                                                <th>
                                                    <h4>{{ $field['column'] }}</h4>
                                                </th>
                                            @endforeach
                ...
                <div class="modal-content rounded-5">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 px-3">
                            ...
                            {{-- Row 1: Department, Problem Category, Sub Category --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_department') }}
                                </label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_problem_category') }}
                                </label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_sub_category') }}
                                </label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_status') }}
                                </label>
                                <select name="filter_by_status[]" id="filter_by_status" class="form-select" multiple>
                                </select>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_date') }}
                                </label>
                                <select name="filter_by_date" id="filter_by_date" class="form-select">
                                    <option value="null">{{ trans('custom_report.no_filter') }}</option>
                                    <option value="1">{{ trans('custom_report.created_date') }}</option>
                                    <option value="2">{{ trans('custom_report.resolved_date') }}</option>
                                    <option value="3">{{ trans('custom_report.closed_date') }}</option>
                                    <option value="4">{{ trans('custom_report.reopened_date') }}</option>
                                </select>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_daterange') }}
                                </label>
                                <div id="reportrange" class="form-control d-flex align-items-center justify-content-between"
                                    ...
                                    <svg width="15px" height="15px" viewBox="0 0 48 48" fill="currentColor">
                                        <title>{{ trans('custom_report.filter_by_daterange') }}</title>
                            ...
                            {{-- Row 3: Location, Base Location, Priority --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_location_id') }}
                                </label>
                                <select name="filter_location_id[]" id="filter_location_id" class="form-select" multiple>
                                </select>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_base_location_id') }}
                                </label>
                                <select name="filter_base_location_id" id="filter_base_location_id" class="form-select">
                                    <option value="null">{{ trans('custom_report.no_filter') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_priority') }}
                                </label>
                                <select name="filter_by_priority[]" id="filter_by_priority" class="form-select" multiple>
                                </select>
                            </div>

                            {{-- Row 4: Ticket Type, Ticket Handler, Custom Field --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_ticket_type') }}
                                </label>
                                <select name="filter_by_ticket_type[]" id="filter_by_ticket_type" class="form-select"
                                    multiple>
                                    <option value="null">{{ trans('custom_report.no_filter') }}</option>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.by_ticket_handler') }}
                                </label>
                                <select name="filter_by_ticket_handlers[]" id="filter_by_ticket_handlers"
                                    class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_custom_field') }}
                                </label>
                                <select name="filter_by_custom_field" id="filter_by_custom_field" class="form-select">
                                </select>
                            </div>

                            {{-- Row 5: Custom Field Value (Full width or half) --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('custom_report.filter_by_custom_field_value') }}
                                </label>
                                <select name="filter_by_custom_field_value" id="filter_by_custom_field_value"
                                    class="form-select" placeholder="Select Custom Field Value">
                                </select>
                            </div>
        ...
        {{-- tag modal --}}
        <div class="amg-modal modal fade" id="ticketReportTagListModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content rounded-5">
                    <div class="modal-header d-flex align-items-center py-3 pt-4">
                        <h3 class="modal-title px-4">{{ trans("custom_report.tags") }}</h3>
                        <button data-bs-dismiss="modal" class="modal-close px-4" aria-label="Close">
                    ...
                    <div class="modal-body" id="ticketReportTagListModalBody"></div>
                    <div class="modal-footer justify-content-start mb-4 py-0">
                        <div class="amg-btn-group mt-3 gap-3 px-4">
                            <button type="button" data-bs-dismiss="modal" class="amg-btn amg-btn-ghost bg-black text-white hover-opacity-80 fw-light min-w-120">
                                {{ trans("button.close") }}
                            </button>
                        </div>
                    </div>
...
@push('css')
    <style>
        ...
        #page-btm-summary .available-records,
        .page-summary .available-records {
            font-weight: 600;
            color: #333;
            font-size: 13px;
        }

        #page-btm-summary .showing-info,
        .page-summary .showing-info {
            font-size: 12px;
            color: #888;
        }
        ...
        .sort-fields .list-group-item {
            ...
            gap: 4px;
            display: flex;
            padding: var(--bs-list-group-item-padding-y, 8px 16px);
            color: var(--bs-list-group-color, #212529);
            text-decoration: none;
...
@endpush
@push('scripts')
    <script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/ticket_report.js') !!}"></script>
    <script type="text/javascript" src="{!! CommonHelper::asset('plugins/simple_pagination/pagination.js') !!}"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            var config = {};
            config.url = {};
            config.url.list_tickets = "{{ url('reports/tickets/jx-ticket-report') }}";
            config.url.export_ticket_xls = "{{ url('reports/export-ticket-report-xls') }}";
            config.url.export_ticket_pdf = "{{ url('reports/export-ticket-report-pdf') }}";
            ...
            config.base_locations = {!! json_encode($vd->base_locations) !!};
            ...
            config.translations = {
                ...
                Show_Categories: '{{ trans('custom_report.show_categories') }}',
                Filter_By_Ticket_Handler: '{{ trans('custom_report.filter_by_ticket_handler') }}',
                Select_the_Ticket_Creator: '{{ trans('custom_report.Select_the_ticket_creator') }}',
                Select_the_Ticket_Handler: '{{ trans('custom_report.select_the_ticket_handler') }}',
                Select_Merged_User: '{{ trans('custom_report.select_merged_user') }}',
                select_department: '{{ trans('custom_report.select_department') }}',
                Filter_By_Created_via: '{{ trans('custom_report.filter_by_created_via') }}',
                select_Problem_Category: '{{ trans('custom_report.select_pc') }}',
                select_Sub_Category: '{{ trans('custom_report.select_sc') }}',
                select_status: '{{ trans('custom_report.select_status') }}',
                Filter_By_Creator_Logger: '{{ trans('custom_report.filter_by_creator_logger') }}',
                select_Priority: '{{ trans('custom_report.select_priority') }}',
                select_Location: '{{ trans('custom_report.select_location') }}',
                Select_the_Escalate_To: '{{ trans('custom_report.select_the_escalate_to') }}',
                no_details: '{{ trans('custom_report.no_details') }}',
                select_base_location: '{{  trans('custom_report.select_base_location') }}',
                Resolver1_name: '{{  trans('custom_report.resolver1_name') }}',
                resolver1_time: '{{  trans('custom_report.resolver1_time') }}',
                Resolver2_name: '{{  trans('custom_report.resolver2_name') }}',
                resolver2_time: '{{  trans('custom_report.resolver2_time') }}',
                Resolver3_name: '{{  trans('custom_report.resolver3_name') }}',
                resolver3_time: '{{  trans('custom_report.resolver3_time') }}',
                Ticket_Sla_Breached: '{{  trans('custom_report.ticket_sla_breached') }}',
                Sla_breached_Time: '{{  trans('custom_report.sla_breached_time') }}',
                customFieldSet: '{{ trans('custom_report.select_custom_field') }}',
                customField: '{{ trans('custom_report.filter_by_custom_field') }}',
            };
            new TicketReport(config);
        });
    </script>
@endpush