...
@section('content')
    <div class="content" id="content-container">
        ...
        <main class="main-content" id="mainContent">
            <div class="container-fluid px-0">
                <div class="card rounded-0">
                    <div class="card-body">
                        {{-- Tabs --}}
                        <ul class="nav nav-pills gray-pills rounded-2 overflow-hidden" id="reportTabs" role="tablist">
                            @can('TicketPendencyReportRead')
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active" id="ticket-tab" data-toggle="tab" data-bs-toggle="tab" href="#ticket" role="tab" aria-controls="ticket" aria-selected="true">Ticket</a>
                            </li>
                            @endcan
                            @can("TechnicianPendencyReportRead")
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" id="technician-tab" data-toggle="tab" data-bs-toggle="tab" href="#technician" role="tab" aria-controls="technician" aria-selected="false">Technician</a>
                            </li>
                            @endcan
                        </ul>
                        ...
                        <div class="tab-content" id="reportTabsContent">
                            @can('TicketPendencyReportRead')
                            <div id="ticket" class="tab-pane fade show active" role="tabpanel" aria-labelledby="ticket-tab">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <div class="col-auto">
                                        <select id="pageLimiter" class="userModulePageLenth amg-table-pagination-dropdown amgTablePageLenth">
                                    ...
                                    <button class="header-icon-btn header-icon-btn-sm btn-open-filter" type="button" data-bs-toggle="tooltip"
                                        ...
                                        <span class="b6-text opacity-50">{{ trans('report.filter') }}</span>
                                        <span class="filter-count-badge d-none" aria-label="{{ trans('report.active_filters') }}">0</span>
                                    </button>

                                    {{-- Download --}}
                                     @can('TicketPendencyReportDownload')
                                        <button class="header-icon-btn-only header-icon-btn-only-sm btn-download" type="button"
                                            data-bs-toggle="tooltip" title="{{ trans('report.download') }}">
                                ...
                                <div class="list-view-panel">
                                    <div class="table-responsive">
                                        <table id="lgTbl" class="table display app-data-table">
                                            <thead class="report-head">
                                                <tr>
                                                    <th colspan="4" class="group-box assigned-box">Categorization</th>
                                                    <th colspan="6" class="group-box assigned-box">Assigned</th>
                                                    <th colspan="6" class="group-box hold-box">Hold</th>
                                                    <th rowspan="2" class="backlog-box">Total Backlog</th>
                                                </tr>
                                                <tr>
                                                    <th>Company</th>
                                                    <th>Department</th>
                                                    ...
                                                    <th>Sub Category</th>
                                                    <th>Up to 5 days</th>
                                                    <th>5 and up to 10 days</th>
                                                    <th>10 days</th>
                                                    <th class="red-text">15 days and up to 1 month</th>
                                                    <th class="red-text">1 month and above</th>
                                                    <th>Total</th>
                                                    <th>Up to 5 days</th>
                                                    <th>5 and up to 10 days</th>
                                                    <th>10 days</th>
                                                    <th class="red-text">15 days</th>
                                                    <th class="red-text">1 month</th>
                                                    <th>Total</th>
                                                </tr>
                                            </thead>
                                            <tbody id="lg">
                            ...
                            @endcan
                            @can("TechnicianPendencyReportRead")
                            <div id="technician" class="tab-pane fade" role="tabpanel" aria-labelledby="technician-tab">
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    <div class="col-auto">
                                        <select id="pageLimiter2" class="userModulePageLenth amg-table-pagination-dropdown amgTablePageLenth">
                                            <option value="10" selected>{{ trans('report.show_10') }}</option>
                                            <option value="25">{{ trans('report.show_25') }}</option>
                                            <option value="50">{{ trans('report.show_50') }}</option>
                                            <option value="100">{{ trans('report.show_100') }}</option>
                                    ...
                                    <div>
                                        <div class="amg-list-searchbar">
                                            ...
                                            <input type="text"
                                                class="amg-list-searchbar__input searchbox2 plain-search"
                                                placeholder="{{ trans('report.search') }}">
                                        </div>
                                    </div>
                                    <button class="amg-refresh-btn btn-reload2">
                                        <svg class="amg-refresh-btn__icon" width="20" height="18" viewBox="0 0 20 18" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M19.5 8.99867C19.5002 11.3648 18.5686 13.6359 16.9069 15.3202C15.2451 17.0046 12.9869 17.9669 10.6209 17.9987H10.5C8.20147 18.0044 5.98901 17.1248 4.32187 15.5424C4.25028 15.4747 4.19273 15.3936 4.1525 15.3036C4.11227 15.2136 4.09016 15.1166 4.08741 15.0181C4.08467 14.9196 4.10136 14.8216 4.13652 14.7295C4.17168 14.6375 4.22463 14.5532 4.29234 14.4816C4.36006 14.41 4.44121 14.3525 4.53116 14.3123C4.62112 14.272 4.71812 14.2499 4.81662 14.2472C4.91512 14.2444 5.0132 14.2611 5.10525 14.2963C5.19731 14.3314 5.28153 14.3844 5.35312 14.4521C6.42544 15.4634 7.77195 16.1363 9.22447 16.3867C10.677 16.6372 12.1711 16.4541 13.5202 15.8603C14.8692 15.2666 16.0134 14.2884 16.8098 13.0482C17.6062 11.8079 18.0195 10.3605 17.9981 8.88668C17.9766 7.41289 17.5214 5.97808 16.6892 4.76151C15.8571 3.54494 14.6849 2.60053 13.3192 2.04626C11.9534 1.492 10.4546 1.35245 9.00998 1.64506C7.56537 1.93766 6.239 2.64944 5.19656 3.69148C5.1889 3.69976 5.18076 3.70759 5.17219 3.71492L2.68031 5.99867H5.25C5.44891 5.99867 5.63968 6.07769 5.78033 6.21834C5.92098 6.35899 6 6.54976 6 6.74867C6 6.94758 5.92098 7.13835 5.78033 7.279C5.63968 7.41965 5.44891 7.49867 5.25 7.49867H0.75C0.551088 7.49867 0.360322 7.41965 0.21967 7.279C0.0790176 7.13835 0 6.94758 0 6.74867V2.24867C0 2.04976 0.0790176 1.85899 0.21967 1.71834C0.360322 1.57769 0.551088 1.49867 0.75 1.49867C0.948912 1.49867 1.13968 1.57769 1.28033 1.71834C1.42098 1.85899 1.5 2.04976 1.5 2.24867V5.04242L4.14844 2.62367C5.40842 1.36858 7.012 0.51492 8.75675 0.170448C10.5015 -0.174024 12.3092 0.00613689 13.9516 0.688188C15.5941 1.37024 16.9976 2.5236 17.9851 4.00268C18.9726 5.48176 19.4997 7.22024 19.5 8.99867Z"
                                    ...
                                    <button class="header-icon-btn header-icon-btn-sm btn-open-filter2" type="button" data-bs-toggle="tooltip"
                                        title="{{ trans('report.filter') }}">
                                        <svg viewBox="0 0 20 18" fill="none">
                                            <path
                                                d="M19.3658 0.893462C19.2504 0.626753 19.0591 0.399864 18.8157 0.241013C18.5723 0.0821617 18.2877 -0.00164211 17.997 2.43793e-05H1.49705C1.20673 0.000596404 0.922821 0.0854027 0.679756 0.244155C0.436692 0.402908 0.244919 0.628785 0.127702 0.894384C0.0104851 1.15998 -0.0271385 1.45389 0.0193952 1.74045C0.065929 2.02701 0.19462 2.29391 0.389858 2.50877L0.397358 2.51721L6.74705 9.29721V16.5C6.74698 16.7715 6.8206 17.0379 6.96004 17.2708C7.09948 17.5038 7.29953 17.6945 7.53885 17.8227C7.77816 17.9508 8.04778 18.0117 8.31894 17.9986C8.59011 17.9856 8.85266 17.8993 9.07861 17.7488L12.0786 15.7481C12.2843 15.6112 12.4529 15.4255 12.5695 15.2076C12.6861 14.9898 12.7471 14.7465 12.747 14.4994V9.29721L19.0977 2.51721L19.1052 2.50877C19.3025 2.29489 19.4324 2.02764 19.4788 1.74037C19.5251 1.4531 19.4858 1.15854 19.3658 0.893462ZM11.4514 8.4919C11.3217 8.62945 11.2487 8.81094 11.247 9.00002V14.4994L8.24705 16.5V9.00002C8.2471 8.80958 8.17471 8.62624 8.04455 8.48721L1.49705 1.50002H17.997L11.4514 8.4919Z"
                                        ...
                                        <span class="b6-text opacity-50">{{ trans('report.filter') }}</span>
                                        <span class="filter-count-badge-report d-none" id="filter-count-badge-report" aria-label="{{ trans('report.active_filters') }}" style="background: #e74c3c;color: #fff;border-radius: 50%; padding: 0 6px;font-size: 10px;line-height: 18px;min-width: 18px;text-align: center;display: inline-block;margin-left: 4px;">0</span>
                                    </button>
                                ...
                                <div class="list-view-panel">
                                    <div class="table-responsive">
                                        <table id="lgTbl2" class="table display app-data-table">
                                            <thead class="report-head">
                                                <tr>
                                                    <th colspan="2" class="group-box assigned-box">Categorization</th>
                                                    <th colspan="6" class="group-box assigned-box">Assigned</th>
                                                    <th colspan="6" class="group-box hold-box">Hold</th>
                                                    <th rowspan="2" class="backlog-box">Total Backlog</th>
                                                </tr>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3">
                                    <div id="page-btm-summary2" class="page-summary"></div>
                                    <div id="pagebtns2"></div>
                                </div>
                            </div>
                            @endcan
                        </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content rounded-5">
                    <div class="modal-header d-flex align-items-center py-3 pt-4">
                        ...
                        <button data-bs-dismiss="modal" class="modal-close px-4" aria-label="{{ trans('report.close') }}">
                        ...
                        <div class="row g-3 px-3">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('content.filter_heading.filter_by_company') }}
                                </label>
                                <select name="filter_by_company[]" id="filter_by_company" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_department[]" id="filter_by_department" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_problem_category[]" id="filter_by_problem_category" class="form-select" multiple>
                                </select>
                            </div>

                            {{-- Row 2: Sub Category, Assigned To, Location --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('content.filter_heading.Filter_By_Sub_Category') }}
                                </label>
                                <select name="filter_by_sub_category[]" id="filter_by_sub_category" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_ticket_handlers[]" id="filter_by_ticket_handlers" class="form-select" multiple>
                                </select>
                            </div>

                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('content.filter_heading.filter_by_location_id') }}
                                </label>
                                <select name="filter_location_id[]" id="filter_location_id" class="form-select" multiple>
                                </select>
                            </div>

                            {{-- Row 3: Date Type, Date Range --}}
                            <div class="col-lg-6 col-md-6">
                                ...
                                <select name="filter_by_date" id="filter_by_date" class="form-select">
                                    ...
                                    <option value="1">{{ trans('content.service_ticket_fields.Created_At') }}</option>
                                    <option value="2">{{ trans('content.service_ticket_fields.Updated_At') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div id="daterange" class="form-control d-flex align-items-center justify-content-between"
                    ...
                    <div class="modal-footer justify-content-end mb-4 pb-4 py-0">
                        <div class="amg-btn-group mt-3 gap-3 px-4">
                            <button type="button" class="amg-btn amg-btn-primary s2-text btn-filter" id="btnSubmitFilter"
        ...
        <div class="amg-modal modal fade" id="FilterModal1" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
            data-bs-keyboard="false">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content rounded-5">
                    <div class="modal-header d-flex align-items-center py-3 pt-4">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 px-3">
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_company[]" id="filter_by_companys" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_department[]" id="filter_by_departments" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_problem_category[]" id="filter_by_problem_categorys" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_sub_category[]" id="filter_by_sub_categorys" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_by_ticket_handlers[]" id="filter_by_ticket_handler" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <select name="filter_location_id[]" id="filter_location_ids" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <select name="filter_by_date" id="filter_by_dates" class="form-select">
                                    <option value="null">{{ trans('content.report_fields.No_Filter') }}</option>
                                    <option value="1">{{ trans('content.service_ticket_fields.Created_At') }}</option>
                                    <option value="2">{{ trans('content.service_ticket_fields.Updated_At') }}</option>
                                </select>
                    ...
                    <div class="modal-footer justify-content-end mb-4 pb-4 py-0">
                        <div class="amg-btn-group mt-3 gap-3 px-4">
                            <button type="button" class="amg-btn amg-btn-primary s2-text btn-filter" id="btnSubmitFilter2"
                                style="min-width: 200px;">
                                {{ trans('report.filter') }}
                            </button>
                            <button type="button" id="btnClrFilter2"
                                class="amg-btn amg-btn-ghost bg-black text-white s2-text" style="min-width: 200px;">
                                {{ trans('report.clear') }}
                            </button>
                        </div>
...
@push('scripts')
    <script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/pendency.js') !!}"></script>
    ...
    $(document).ready(function() {
        ...
        var config = {};
        config.url = {};
        config.url.list_tickets = "{{ url('reports/tickets/jx-pendency-report') }}";
        config.url.export_ticket_xls = "{{ url('reports/export-ticket-pendency-xls') }}";
        config.url.getTicketnicianPendencyTicketReport = "{{ url('reports/tickets/jx-technician-pendency-report') }}";
        config.url.getTicketnicianPendencyTicketDownload = "{{ url('reports/export-technician-pendency-report') }}";
        ...
        config.getCompanyByUserAccess = "{{ url('getCompanyByUserAccess') }}";
        config.getDepartmentsWithCompanyByQuery = "{{ url('getDepartmentsWithCompanyByQuery') }}";
        ...
        config.company = config.user.company_id;
        config.sort_dir = { id: 1, dir: 2 };
        config.locations = {!! json_encode($vd->locations) !!};
        config.token = "{{ csrf_token() }}";
        config.translations = {
            serach_option: '{{ trans('report.search') }}',
            No_Filter: '{{ trans('report.no_filter') }}',
            Filter_By_Ticket_Handler: '{{ trans('report.filter_by_ticket_handler') }}',
            filter_by_location: '{{ trans('report.filter_by_location') }}',
            filter_by_company: '{{ trans('report.filter_by_company') }}',
            filter_by_department: '{{ trans('report.filter_by_department') }}',
            no_details: '{{ trans('report.no_records') }}',
            select_assign_to: '{{ trans('report.select_assign_to') }}',
            select_department: '{{ trans('report.select_department') }}',
            select_Problem_Category: '{{ trans('report.select_problem_category') }}',
            select_Sub_Category: '{{ trans('report.select_sub_category') }}',
            select_status: '{{ trans('report.select_status') }}',
            select_Priority: '{{ trans('report.select_priority') }}',
            filter: '{{ trans('report.filter') }}',
            clear: '{{ trans('report.clear') }}',
            refresh: '{{ trans('report.refresh') }}',
            download: '{{ trans('report.download') }}',
            close: '{{ trans('report.close') }}',
            search: '{{ trans('report.search') }}',
            show_10: '{{ trans('report.show_10') }}',
            show_25: '{{ trans('report.show_25') }}',
            show_50: '{{ trans('report.show_50') }}',
            show_100: '{{ trans('report.show_100') }}',
            active_filters: '{{ trans('report.active_filters') }}',
            something_wrong: '{{ trans('report.something_wrong') }}',
            filter_by_date: '{{ trans('report.filter_by_date') }}',
            filter_by_daterange: '{{ trans('report.filter_by_daterange') }}',
            filter_by_ticket_creator: '{{ trans('report.filter_by_ticket_creator') }}',
        };

        // Initialize Ticket Pendency Report
        if (typeof PendencyTicketReport !== 'undefined') {
            try {
                new PendencyTicketReport(config);
                console.log('PendencyTicketReport initialized successfully');
            } catch(e) {
                console.error('Error initializing PendencyTicketReport:', e);
            }
        } else {
            console.warn('PendencyTicketReport is not defined');
        }

        // Initialize Technician Pendency Report
        if (typeof VendorTicketReport !== 'undefined') {
            try {
                // Wait a moment for the first report to initialize
                setTimeout(function() {
                    new VendorTicketReport(config);
                    console.log('VendorTicketReport initialized successfully');
                }, 100);
            } catch(e) {
                console.error('Error initializing VendorTicketReport:', e);
            }
        } else {
            console.warn('VendorTicketReport is not defined');
        }
    });
    </script>
@endpush