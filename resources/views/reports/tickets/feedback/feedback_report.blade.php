...
@section('title', trans("content.report_fields.feedback_report"))
@section('content')

<div class="content">
    <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
        <h3 class="h3-text mb-0">{{ trans("content.report_fields.feedback_report") }}</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="js-user-list-view-panel">
                        <div class="gtable-cover">
                            <table id="lgTbl" class="mytable table table-striped">
                                <thead>
                                    <tr id="tHeadeRow">
                                        ...
                                        <th>Location</th>
                                        <th>{{ trans("content.ticket_report.ticket_type") }}</th>
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-body">
                    <div class="row g-3 px-3">
                        ...
                        <!-- Date Type -->
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <label class="form-label b5-text">Filter By Date</label>
                            <select id="filter_by_date" name="filter_by_date" class="form-select select2-modal">
                                ...
                                <option value="1">Resolved At</option>
                                <option value="2">Feedback Date</option>
                            </select>
                        </div>

                        <!-- Date Range -->
                        <div class="col-lg-3 col-md-6">
                            <label class="form-label b5-text">Date Range</label>
                            <div id="reportrange"
...
@push('scripts')
    <script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/feedback_report.js') !!}"></script>
    <script src="{!! CommonHelper::asset('js/common.js') !!}"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            var config = {};
            config.url = {};
            config.url.list_tickets = "{{ url('reports/tickets/jx-feedback-report') }}";
            config.url.export_feedback_xls = "{{ url('reports/export-feedback-report-xls') }}";
            config.url.export_feedback_pdf = "{{ url('reports/export-feedback-report-pdf') }}";
            ...
            config.translations = {
                ...
                filter_by_resolver: '{{ trans('content.report_fields.filter_by_resolver') }}',
                filter_by_location_id: '{{ trans('content.filter_heading.filter_by_location_id') }}',
            };
            new FeedbackReport(config);
        });
    </script>
@endpush