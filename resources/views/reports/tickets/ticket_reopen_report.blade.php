...
@section('title', trans("content.report_fields.reopen_ticket_report"))
@section('content')

<div class="content">
    <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
        <h3 class="h3-text mb-0">{{ trans("content.report_fields.reopen_ticket_report") }}</h3>
        <div class="d-flex gap-8">
            <div data-bs-toggle="tooltip" title="{{ trans('service_ticket.sort') }}">
                <div class="header-icon-btn dropdown sort-buttons" id="srqSortDrop">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end list-group sort-fields p-0"></ul>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="js-user-list-view-panel">
                        <div class="gtable-cover">
                            <table id="lgTbl" class="mytable amg-datatable table display app-data-table">
                                <thead>
                                    <tr id="tHeadeRow">
                                        <th>{{ trans("content.ticket_report.Ticket_Id") }}</th>
                                        <th>{{ trans("content.ticket_report.Department") }}</th>
                                        <th>{{ trans("content.ticket_report.Problem_Category") }}</th>
                                        <th>{{ trans("content.ticket_report.Sub_Category") }}</th>
                                        <th>{{ trans("content.ticket_report.Ticket_Created_At") }}</th>
                                        <th>{{ trans("content.ticket_report.ticket_changed") }}</th>
                                        <th>{{ trans("content.ticket_report.Status") }}</th>
                                        <th>{{ trans("content.ticket_report.Tat") }}</th>
                                        <th>{{ trans("content.report_fields.Priority") }}</th>
                                        <th>{{ trans("content.ticket_report.tkt_handler") }}</th>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    <h4 class="modal-title s1-text fw-semibold">Filter</h4>
                ...
                <div class="modal-body">
                    <div class="row g-3 px-3">
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <label>{{ trans("content.filter_heading.filter_by_status") }}</label>
                            <select id="filter_by_status" name="filter_by_status[]" multiple="multiple">
                                <option value="null">{{ trans("content.service_ticket_fields.No_Filter") }}</option>
                            </select>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <label class="form-label b5-text">{{ trans("content.filter_heading.filter_by_department") }}</label>
                            <select id="filter_by_department" name="filter_by_department[]" multiple></select>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <label class="form-label b5-text">{{ trans("content.filter_heading.Filter_By_Problem_Category") }}</label>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <label class="form-label b5-text">{{ trans("content.filter_heading.Filter_By_Priority") }}</label>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            ...
                            <select id="filter_by_location" name="filter_by_location[]" multiple></select>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <label class="form-label b5-text">{{ trans("content.filter_heading.filter_by_ticket_type") }}</label>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            ...
                            <select id="filter_by_date" name="filter_by_date" class="form-select select2-modal">
                                <option value="null">{{ trans("content.report_fields.No_Filter") }}</option>
                                <option value="1">Ticket Created At</option>
                                <option value="2">Ticket Status Changes To Reopened</option>
                            </select>
                        </div>
...
<style>
    ...
    .sort-fields .list-group-item:last-child {
        border-bottom: none;
    }

    .sort-fields .list-group-item:hover {
    ...
    .sort-fields .list-group-item.selected .like-radio::after {
        opacity: 1;
    }
...
<script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/ticket_reopen_report.js') !!}"></script>

<script type="text/javascript">
    $(document).ready(function() {
        var config = {};
        config.url = {};
        config.url.list_tickets = "{{ url('reports/tickets/jx-reopen-report') }}";
        config.url.export_ticket_xls = "{{ url('reports/export-ticket-reopen-report-xls') }}";
        config.url.export_ticket_pdf = "{{ url('reports/export-ticket-reopen-report-pdf') }}";
