...
@section('title', trans("report.service_request_report"))
@section('content')
    <div class="content" id="content-container">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <h3 class="h3-text mb-0">{{ trans('report.service_request_report') }}</h3>
                        ...
                        <div class="list-view-panel">
                            <div class="table-responsive">
                                <table id="lgTbl" class="table display app-data-table">
                                    <thead>
                                        <tr>
                                            <th><h4 class="b2-text">{{ trans("report.procure_tag") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.subject") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.department") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.problem_category") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.sub_category") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.creator") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.request_created_at") }}</h4></th>
                                            <th><h4>{{ trans("report.authority_board") }}</h4></th>
                                            <th><h4>{{ trans("report.status") }}</h4></th>
                                            <th class="amg-table-col-176"><h4>{{ trans("report.approval_date") }}</h4></th>
                                            <th><h4>{{ trans("report.ticket_id") }}</h4></th>
                                            <th><h4>{{ trans("report.ticket_status") }}</h4></th>
                                        </tr>
                                    </thead>
                                    <tbody id="lg">
                                    </tbody>
                ...
                <div class="modal-content rounded-5">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 px-3">
                            ...
                            {{-- Row 2: Status, Ticket Creator, Authority Board --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('report.filter_by_status') }}
                                </label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('report.filter_by_ticket_creator') }}
                                </label>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('report.by_authority_board') }}
                                </label>
                                <select name="filter_by_pab[]" id="filter_by_pab" class="form-select" multiple>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <select name="filter_by_date" id="filter_by_date" class="form-select">
                                    ...
                                    <option value="5">{{ trans('report.approval_date') }}</option>
                                </select>
                            </div>

                            <div class="col-lg-6 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans('report.filter_by_daterange') }}
                                </label>
...
@endsection
@push('scripts')
<script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/request/service_request_report.js') !!}"></script>
<script type="text/javascript">
    $(document).ready(function() {
        var config = {};
        config.url = {};
        config.url.list_tickets = "{{ url('reports/tickets/jx-request-report') }}";
        config.url.export_ticket_xls = "{{ url('reports/export-request-report-xls') }}";
        ...
        config.url.service_request_info = "{{ url('tickets/requestInfo') }}";
        ...
        config.translations = {
            ...
            by_authority_board: '{{ trans('report.by_authority_board') }}',
            please_select_option: '{{ trans('report.please_select_option') }}',
            filter_by_tag: '{{ trans('report.filter_by_tag') }}',
            filter_by_ticket_type: '{{ trans('report.filter_by_ticket_type') }}',
            filter_by_base_location: '{{ trans('report.filter_by_base_location') }}',
            filter_by_custom_field: '{{ trans('report.filter_by_custom_field') }}',
            filter_by_custom_field_value: '{{ trans('report.filter_by_custom_field_value') }}',
        };
        new RequestReport(config);
    });
</script>
@endpush