...
@section('title', trans("content.ticket_report.SrMember_report"))

@section('content')
    <div class="content" id="content-container">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <h3 class="h3-text mb-0">{{ trans("content.ticket_report.SrMember_report") }}</h3>
                        ...
                        <div class="list-view-panel">
                            <div class="table-responsive">
                                <table id="lgTbl" class="table display app-data-table">
                                    <thead>
                                        <tr>
                                            <th><h4 class="b2-text">{{ trans("content.ticket_report.member_name") }}</h4></th>
                                            <th><h4>{{ trans("content.ticket_report.pab") }}</h4></th>
                                            <th><h4>{{ trans("content.ticket_report.Approval_Mode") }}</h4></th>
                                            <th><h4>{{ trans("content.ticket_report.member_approve") }}</h4></th>
                                            <th><h4>{{ trans("content.ticket_report.member_reject") }}</h4></th>
                                            <th><h4>{{ trans("content.ticket_report.member_pending") }}</h4></th>
                                        </tr>
                                    </thead>
                                    <tbody id="lg">
                                    </tbody>
                ...
                <div class="modal-content rounded-5">
                    ...
                    <div class="modal-body">
                        <div class="row g-3 px-3">
                            ...
                            {{-- Row 2: Ticket Creator, Authority Board --}}
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <label class="form-label b5-text">
                                    {{ trans("content.filter_heading.By_Authority_Board") }}
                                </label>
...
@endsection
@push('scripts')
<script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/request/sr_member_report.js') !!}"></script>
<script type="text/javascript">
    $(document).ready(function() {
        var config = {};
        config.url = {};
        config.url.list_tickets = "{{ url('reports/tickets/jx-request-member-wise') }}";
        config.url.export_ticket_xls = "{{ url('reports/tickets/jx-request-download-member-wise') }}";
