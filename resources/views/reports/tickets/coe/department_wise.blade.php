...
@section('title', trans('content.report_fields.Ticket_Department_Wise_Report'))
@section('content')

    <div class="content">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <h3 class="h3-text mb-0">{{ trans('content.report_fields.Ticket_Department_Wise_Report') }}</h3>
                            ...
                            <div>
                                <div class="amg-list-searchbar">
                                    ...
                                    <input type="text"
                                        ...
                                        id="announcement-list-search" placeholder="{{ trans('internal_place.view.search') }}...">
                                </div>
                            </div>
...
@push('scripts')
    <script type="text/javascript" src="{!! CommonHelper::asset('js/reports/tickets/coe/department_wise.js') !!}"></script>
