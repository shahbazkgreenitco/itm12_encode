<div id="accessoryChangeInfoModal" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static"
        ...
        <div class="modal-content rounded-5">
            ...
            <div class="modal-header d-flex align-items-center py-3 pt-4">
                <h3 class="modal-title px-4">
                    {{ trans('accessories.accessory_history.accessory_change_info') }}
                </h3>
            ...
            <div class="modal-body bg-white">
                <div class="container-fluid py-3">
                    <div class="table-responsive" style="max-height:65vh;overflow-y:auto;">
                        <table id="accessory-history-table" class="table table-bordered align-middle mb-0">

                            <thead>
                                <tr>
                                    <th width="28%">
                                        {{ trans('accessories.accessory_fields.accessory_info') }}
                                    </th>

                                    <th width="36%">
                                         {{ trans('accessories.accessory_history.updated_info') }}
                                    </th>

                                    <th width="36%">
                                        {{ trans('accessories.accessory_history.old_info') }}
                                    </th>
                                </tr>
                            </thead>

                            <tbody id="accessory-change-info-body">
                            </tbody>
