...
@section('title', trans('content.accessory_fields.accessory_import'))
@section('content')
<style>
    :root {
        --primary: #1a2e5a;
        ...
        <div class="py-3">
            <div class="container-fluid">
                <button onclick="location.href='{{ url('accessories') }}'"
                    ...
                    <h2 class="h2-text mb-0">{{ trans('content.accessory_fields.accessory_import') }}</h2>
                </button>
            </div>
        </div>
    </div>
            ...
            <ul class="nav nav-underline" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="info-tab-link" data-bs-toggle="tab" href="#info-tab" role="tab">
                        <span>{{ trans('content.tab_header.bulk_import') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="import-info-tab-link" data-bs-toggle="tab" href="#import-info-tab"
                        role="tab">
                        <span>{{ trans('content.tab_header.accessory_import_info') }}</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-pane fade show active container-fluid pt-3 pb-5" id="info-tab">
                ...
                <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                        ...
                        {{ trans('accessories.accessory_import.import_success', ['count' => session('success',0)]) }}
                    </div>
                </div>
                @endif --}}
                ...
                <div class="alert customize-alert alert-dismissible alert-light-danger bg-danger-subtle text-danger fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-start me-3 gap-3 me-md-0">
                        ...
                        <div>
                            {{-- {{ session('fail', 0) }} Purchase_imported_failed --}}
                            {{ trans('accessories.accessory_import.import_failed', ['count' => session('fail',0)]) }}
                ...
                <div class="alert customize-alert alert-dismissible alert-light-warning bg-warning-subtle text-warning fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                        ...
                        {{ trans('accessories.accessory_import.import_default_success') }}
                    </div>
                </div>
                @endif --}}
                            ...
                            <div class="drop-zone" id="dropZone">
                                ...
                                <div id="defaultState">
                                    ...
                                    <p class="drag-text mt-3 mb-2 b1-text">{{
                                        trans("accessories.accessory_import.drag_drop_file") }}
                                    </p>
                                    <button class="amg-btn amg-btn-secondary" style="min-width:203px;">
                                        ...
                                        <span>{{ trans("accessories.accessory_import.upload_file_btn") }}</span>
                                    </button>
                                    <span class="file-label b1-text">{{
                                        trans("accessories.accessory_import.no_file_selected")
                                        }}</span>
                                </div>
                                ...
                                <div id="selectedState" style="display:none;">
                                    ...
                                    <p class="file-selected-name mb-2 mt-3" id="selectedFileName">{{
                                        trans('accessories.accessory_import.format_excel_sheet') }}</p>
                                    <button class="amg-btn amg-btn-primary" style="min-width:203px" type="button"
                                        ...
                                        {{-- <span>Save</span> --}}
                                        <span>{{ trans('accessories.accessory_import.save_import') }}</span>
                                    </button>
                                    <button class="amg-btn amg-btn-link amg-btn-link-plain mt-2" id="btnRemove">{{
                                        trans('accessories.accessory_import.remove_file') }}</button>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-sm-7">
                            <div class="right-panel h-100">
                                <a class="amg-btn amg-btn-white amg-btn-lg"
                                    href="{!! CommonHelper::asset('samples/AccessoryImportFormat.xlsx') !!}"
                                    target="_blank">
                                    ...
                                    <span class="font-weight-normal">{{
                                        trans('accessories.accessory_import.download_template') }}</span>
                    ...
                    <div class="col-12 px-5">
                        ...
                        <div class="instructions-card mt-3">
                            ...
                            <h4 class="h4-text" style="color:#7F7F7F">
                                {{ trans("accessories.accessory_import.upload_notes_title") }}
                            </h4>
                            ...
                            <div class="ps-3 ps-sm-4">
                                ...
                                <div class="card-scroll-body" id="cardScrollBody">
                                    ...
                                    <ul class="ps-3">
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.licenses_fields.unique_tag") }}
                                                <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.unique_tag_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.company") }}
                                            </span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.company_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.accessory_fields.name") }}
                                                <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.name_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.accessory_fields.department")
                                                }} <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.department_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.accessory_fields.category")
                                                }}
                                                <span class="mandatory"></span>
                                            </span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.category_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.accessory_fields.manufacturer")
                                                }}<span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.manufacturer_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.supplier")
                                                }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.supplier_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.accessory_fields.location")
                                                }} <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.location_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.qty") }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.qty_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.threshold")
                                                }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.qty_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.consumables_fields.reorder_limit")
                                                }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.consumables_fields.quantity_field")
                                                }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{
                                                trans("content.consumables_fields.threshold_alerts") }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.consumables_fields.threshold_alert_con_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{
                                                trans("content.accessory_fields.purchase_reference") }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.purchase_reference_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.purchase_date")
                                                }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.purchase_date_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{
                                                trans("content.accessory_fields.purchase_currency_format") }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.purchase_currency_format_field")
                                                }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.purchase_cost")
                                                }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.purchase_cost_field") }}</span>
                                        </li>


                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.order_number")
                                                }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.order_number_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.accessory_fields.notes") }}</span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.accessory_fields.notes_field") }}</span>
                                        </li>
                                        ...
                                        <li><strong>{{ trans("content.download_format.custom_fields") }}:</strong>
                                            <p>{{ trans("content.download_format.custom_field_val_accessory") }}</p>
                                        </li>
                                        @endif
                                ...
                                <a class="amg-btn amg-btn-link amg-btn-link-plain s1-text mt-2" id="readMoreBtn">
                                    {{ trans("accessories.accessory_import.read_more") }}
                                </a>
                            </div>

                            <h4 class="h4-text" style="color:#7F7F7F">
                                {{ trans('accessories.accessory_import.do_not_change_header') }} </h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-2 mb-4" data-select2-id="select2-data-5-1om7">
                            ...
                            <div id="customLengthContainer" class="col-auto" data-select2-id="select2-data-4-sbib">
                                <select id="showSelect" class="showSelect">
                                    <option value="10" selected>{{ trans('accessories.accessory_import.show') }}(10)
                                    </option>
                                    <option value="25">{{ trans('accessories.accessory_import.show') }}(25)</option>
                                    <option value="50">{{ trans('accessories.accessory_import.show') }}(50)</option>
                                    <option value="100">{{ trans('accessories.accessory_import.show') }}(100)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <div class="amg-list-searchbar">
                                    ...
                                    <input type="text" class="amg-list-searchbar__input" id="tableSearch"
                                        placeholder="{{ trans('accessories.accessory_import.search_placeholder') }}">
                                </div>
                            </div>
                            ...
                            <button class="amg-refresh-btn btn-reload-list">
                                ...
                                <span>{{ trans('accessories.accessory_import.refresh') }}</span>
                            </button>
                        </div>
                        <table id="tblHistory" class="table display ">
                            <thead>
                                <tr>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.id') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.document_name') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.total_upload') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.total_success') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.total_failure') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.updated_at') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.username') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('accessories.accessory_import.actions') }}</h4>
                                    </th>
                                </tr>
                            </thead>
                            <tbody></tbody>
...
<script type="text/javascript" src="{!! CommonHelper::asset('js/accessories/accessories_import.js') !!}"></script>

<script>
    var config = {};
       config.accessories_import_info = "{{ url('accessories/import_info') }}";
