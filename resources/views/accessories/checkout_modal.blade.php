...
------------------------------------------------------------
Purpose:
Accessories Checkout Management Modal
...
*/
--}}
<div id="accessory-checkout-mdl" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <form id="accessory-checkout-mdl-frm" class="w-100 amg-form-theme" method="post">
            @csrf
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    <h3 class="modal-title px-4">
                        {{ trans("accessories.accessory_fields.checkout_accessory") }}
                    </h3>
                            ...
                            <div class="col">
                                ...
                                <div class="row px-4">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="amg-form-field amg-form-field-row">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-control bg-light" id="lblAccessoryName">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="amg-form-field amg-form-field-row">
                                            <label class="form-label me-2 mb-0 text-end">
                                                {{ trans("accessories.accessory_fields.accessory_category") }}
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="bi bi-grid"></i>
                                                </span>
                                                <div class="form-control bg-light" id="lblAccessoryCategory">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="amg-form-field amg-form-field-row">
                                            <label class="form-label me-2 mb-0 text-end required">
                                                {{ trans("accessories.accessory_fields.checkout_to") }}
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-md-6 mb-4 cover">
                                        <div class="amg-form-field amg-form-field-row">
                                            <label class="form-label me-2 mb-0 text-end required">
                                                {{ trans("accessories.accessory_fields.checkout_user") }}
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-md-6 mb-4 cover">
                                        <div class="amg-form-field amg-form-field-row">
                                            <label class="form-label me-2 mb-0 text-end required">
                                                {{ trans("accessories.accessory_fields.checkout_place") }}
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="bi bi-geo-alt"></i>
                                                </span>
                                                <select name="assigned_place" id="assigned_place" class="form-select">
                                                </select>
                                            </div>
                                            <div class="amg-form-error-wrap"></div>
                                        </div>
                                    ...
                                    <div class="col-md-6 mb-4 cover">
                                        <div class="amg-form-field amg-form-field-row">
                                            <label class="form-label me-2 mb-0 text-end required text-nowrap d-inline-flex align-items-center gap-1">
                                                {{ trans("accessories.accessory_fields.checkout_device") }}
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="amg-form-field amg-form-field-row">
                                            <label class="form-label me-2 mb-0 text-end">
                                                {{ trans("accessories.accessory_fields.expected_checkin_date") }}
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
...
{{-- <style>
    .amg-form-field .form-label.required {
    display: inline-flex;
    align-items: center;
    gap: 4px;
    white-space: nowrap;
