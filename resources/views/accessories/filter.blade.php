...
------------------------------------------------------------
Purpose:
Accessories Advanced Filter Modal
...
*/
--}}
<div class="amg-modal modal fade" id="accessoryFilterModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered" style="max-width: 1200px;">
        <div class="modal-content rounded-5 bg-white">
            ...
            <div class="modal-header d-flex align-items-center py-3 pt-4">
                <h3 class="modal-title px-4">{{ trans("accessories.filter_heading.filter_accessories") }}</h3>
            ...
            <div class="modal-body">
                <div class="row g-3 px-4">
                    ...
                    <!-- Department -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.filter_by_department") }}</label>
                        <select id="filter_by_department" class="form-select"></select>
                    </div>

                    <!-- Location -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.filter_by_location") }}</label>
                    ...
                    <!-- Internal Place -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.filter_by_internal_place")
                            }}</label>
                    ...
                    <!-- Category -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.filter_by_category") }}</label>
                ...
                <div class="row g-3 mt-3 px-4">
                    ...
                    <!-- Available -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.available_accessories")
                            }}</label>
                        <select id="filter_by_available_accessories" class="form-select filter-input">
                    ...
                    <!-- Purchase Ref -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.Filter_By_Assigned_For")
                            }}</label>
                        <select id="assigned_for" class="form-select filter-input">
                            <option value="">{{ trans("content.service_ticket_fields.No_Filter") }}</option>
                    ...
                    <div class="col-md-3">
                        <label class="form-label">{{
                            trans("accessories.filter_heading.Filter_By_Purchase_Reference")
                            }}</label>
                    ...
                    <!-- Date -->
                    <div class="col-md-3">
                        <label class="form-label">{{ trans("accessories.filter_heading.filter_by_date") }}</label>
            ...
            <div class="modal-footer justify-content-start mb-4 pb-4 py-0">
                <div class="amg-btn-group mt-3 gap-3 px-4">
                    <button class="amg-btn amg-btn-primary filter" style="min-width: 300px;">
                        {{ trans("accessories.filter_heading.Filter") }}
                    </button>
                    <button class="amg-btn amg-btn-ghost bg-black text-white clear" style="min-width: 300px;">
                        {{ trans("accessories.filter_heading.Clear") }}
                    </button>
                </div>
            </div>
