...
[1.0.1] - Updated PDF generation to use Spatie Laravel PDF package and change the ui of this - Safdar Ali - 2026-06-11
------------------------------------------------------------
*/
--}}
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $d->loc_name }}</td>
                <td>
                    {{ $d->purchase_currency ?? 'N/A' }}
                    {{ $d->purchase_cost_format ?? '0.00' }}
                </td>
                <td>{{ $d->purchase_date_on }}</td>
                <td>{{ $d->order_number }}</td>
                <td>{{ $d->qty }}</td>
                <td>{{ $d->accessory_thresholds }}</td>
                <td>{{ $d->remaining }}</td>
                <td>{{ $d->scrap_qty }}</td>
            </tr>
