  ...
  "versions": [
    {
      ...
      "from": "2026-06-03",
      "reviewer": null,
      "description": "Add Relevant Project Modal"
    }
  ]
}
--}}
<div class="amg-modal amg-form-modal modal fade" id="relevant-project-mdl" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    data-bs-keyboard="false">

    <div class="modal-dialog modal-lg">

        <form id="relevant-project-mdl-frm" name="task" method="POST" action="#" class="form-horizontal"
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row align-items-center amg-form-field amg-form-field-row">
                   ...
                   {{-- <div class="modal-footer">
                    <button type="submit" id="btnSubmit" class="btn btn-theme-red">{{ trans("button.add") }}</button>
                    <button type="button" class="btn btn-theme-black" data-dismiss="modal">{{ trans("button.close") }}</button>
                </div> --}}
                <!-- Footer -->
