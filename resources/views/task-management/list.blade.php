    ...
    <div id="task-management-list-wrapper">
        ...
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            ...
            <div class="d-flex gap-8">
                ...
                <div class="amg-sort-wrapper position-relative" data-bs-toggle="tooltip" title="{{ trans('service_ticket.sort') }}">
            ...
            <div class="container-fluid px-0">
                <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        {{-- ── Toolbar: page limiter + search + refresh (mirrors SR) ── --}}
                        ...
                        {{-- ── Dynamic task cards injected here by Listing.js ── --}}
                        <div class="task-list-body task-card-wrapper d-flex flex-column gap-3"></div>

                        {{-- ── Pagination footer injected here by Listing.js ── --}}
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            config.url.archivedExport = "{{ url('task-management/archivedExport') }}";
            ...
            config.url.archived_requests = "{{ url('task-management/archivedAjaxList') }}";
            config.task_statuses = {!! json_encode($status) !!};
            ...
            config.auth_user_id = {!! json_encode(Auth::user()->id) !!};
            ...
            config.translations = {
                ...
                edit:"{{trans('task.task_management.edit')}}",
                info:"{{trans('task.task_management.info')}}",
                history: "{{trans('task.task_management.history')}}",
                delete: "{{trans('task.task_management.delete')}}",
                update: "{{trans('task.task_management.update')}}",
                reopen: "{{ trans('task.task_management.repoen') }}",
            };
