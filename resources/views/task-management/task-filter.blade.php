...
--}}
<div class="amg-modal amg-filter-modal modal fade show" id="taskFilterModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="modal-content rounded-5">
            ...
            <div class="modal-body">
                <div class="row g-3 px-4">
                    <div class="col-md-3">
                        <label class="form-label b1-text">{{ trans('content.filter_heading.Filter_By_status')}}</label>
                        <select id="filter_by_status" name="filter_by_status[]" autocomplete="off"
                    ...
                    <div class="col-md-3">
                        <label
                            class="form-label b1-text">{{ trans("content.filter_heading.Filter_By_Priority") }}</label>
                        <select name="filter_by_priority[]" id="filter_by_priority" autocomplete="off"
                            class="form-select filter-input" multiple></select>
                    </div>
                    <div class="col-md-3">
                        <label
                            class="form-label b1-text">{{ trans("content.filter_heading.filter_by_task_handler") }}</label>
                        <select id="filter_by_task_handlers" name="filter_by_task_handlers[]"
                            class="form-select filter-input" multiple></select>
                    </div>
                    <div class="col-md-3">
                        <label
                            class="form-label b1-text">Filter By Related To</label>
                        ...
                        {{-- <select name="type_id" id="type_id" class="form-select filter-input">
                            @foreach (\App\Models\TaskManagement\TaskType::all() as $s)
                                <option value="{{ $s->id }}">{{ $s->name }}</option>
                            @endforeach
                        </select> --}}
                        <select name="type_id" id="type_id" class="form-select filter-input">
                            <option value="">Filter by Related To</option>  {{-- ← blank placeholder option --}}
                            @foreach (\App\Models\TaskManagement\TaskType::all() as $s)
                                <option value="{{ $s->id }}">{{ $s->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3 mt-8 px-4">
                    <div class="col-md-3">
                        ...
                        {{-- <select name="filter_by_date" id="filter_by_date" class="form-select filter-input"
                            ...
                            <option value="3">Archived Date</option>
                        </select> --}}
                        <select name="filter_by_date" id="filter_by_date" class="form-select filter-input" autocomplete="off">
                            <option value="">{{ trans("content.service_ticket_fields.No_Filter") }}</option>
                            <option value="1">Start Date (Created At)</option>
                    ...
                    <div class="col-md-5">
                        <label
                            class="form-label b1-text">{{ trans("content.filter_heading.filter_by_daterange") }}</label>
