  ...
  "versions": [
    {
      ...
      "from": "2026-07",
      "reviewer": null,
      "description": "Added Task History Modal matching Ticket History design"
    }
  ]
}
--}}
<div class="amg-modal amg-form-modal modal modal-lg fade" id="taskHistoryModal" tabindex="-1"
    aria-labelledby="taskHistoryModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog">
        <form id="task-history-mdl-frm" class="form-horizontal w-100 amg-form-theme" autocomplete="off"
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    <h3 class="modal-title s2-text fw-semibold px-2" id="modalTitle">Task History</h3>
                ...
                <div class="modal-body px-0">
                    <div class="container py-4" style="max-width: 760px;">
                        ...
                        <div class="header-card d-flex flex-column flex-sm-row mb-0">
                                ...
                                <div class="lbl">
                                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#7F7F7F" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                    Department
                                </div>
                                <div class="lbl task-history-related-device-row" style="display:none;">
                                    <svg width="17" height="17" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M2 3.5C2 2.67 2.67 2 3.5 2h9c.83 0 1.5.67 1.5 1.5v6c0 .83-.67 1.5-1.5 1.5H9v1h2a.5.5 0 010 1H5a.5.5 0 010-1h2v-1H3.5A1.5 1.5 0 012 9.5v-6z"
                                            stroke="#7F7F7F" stroke-width="1.4" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                    Ticket
                                </div>
                                <div class="lbl task_history_details_category-row" style="display:none;">
                                    <svg width="17" height="17" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect x="2" y="2" width="5" height="5" rx="1" stroke="#7F7F7F"
                                            stroke-width="1.4" />
                                        <rect x="9" y="2" width="5" height="5" rx="1" stroke="#7F7F7F"
                                            stroke-width="1.4" />
                                        <rect x="2" y="9" width="5" height="5" rx="1" stroke="#7F7F7F"
                                            stroke-width="1.4" />
                                        <rect x="9" y="9" width="5" height="5" rx="1" stroke="#7F7F7F"
                                            stroke-width="1.4" />
                                    </svg>
                                    Category
                                </div>
                                <div class="lbl task-history-subcategory-row" style="display:none;">
                                    <svg width="17" height="17" viewBox="0 0 16 16" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 3h4l1 2h5v7H3V3z" stroke="#7F7F7F" stroke-width="1.4"
                                            stroke-linejoin="round" />
                            ...
                            <div class="header-right p-4 d-flex flex-column gap-2">
                                <div class="lead-line" id="task_history_details_subject" data-bs-toggle="tooltip"></div>
                                <div class="lead-line" id="task_history_details_id"></div>
                                <div class="lead-line" id="task_history_details_department"></div>
                                <div class="lead-line" id="task_history_details_device"></div>
                                <div class="lead-line" id="task_history_details_category" style="display:none;">
                                </div>
                                <div class="lead-line" id="task_history_details_subcategory" style="display:none;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-wrap">
                            ...
                            <section id="task_history_container" aria-live="polite"></section>
                            <div class="task-history-loader d-none text-center py-2">
...
<style>
    ...
    .t-actor a {
        ...
        border-bottom: 1px solid #F12F35;
        white-space: nowrap;
        overflow: hidden;
    ...
    [data-bs-theme=dark] .header-to-timeline,
    [data-bs-theme=dark] .timeline-rail {
        background: #fff;
    }
