...
* Module: Login Module (Forget Password)
* LOG/26/02
* ------------------------------------------------------------
* Version: 1.0.0
...
@section('title', 'Forget Password - AMG')
                ...
                <div class="col-12 col-lg-6 col-xl-5 col-xxl-6 auth-right">
                    ...
                    <div class="login-card">
                        ...
                        <div class="client-brand">
                            <img src="{{ asset('imgs/auth/elringklinger-logo.png') }}" alt="ElringKlinger" class="client-brand-img" />
                        </div>
                        <p class="sub">Enter Registered Username / Email To Reset Password</p>
                        <form name="user" id="mail" action="{{ url('forgot-password') }}" method="post">
                            {{ csrf_field() }}
                            <div class="mb-2">
                                <input type="text" name="email" id="email" class="form-control auth-input @error('email') is-invalid @enderror" placeholder="Enter Your Email Address" value="{{ old('email') }}"  required />

                            </div>
                            @if (count($errors))
                                <label class="error">{{ $errors->first('email') }}</label>
                            @endif
                             <button type="submit" name="action_type" value="sign_in" class="btn-continue mb-2" id="btnSubmit">
                                <span class="btn-spinner" id="continueSpinner"></span>
                                <span id="continueTxt">Sign In</span>
                            </button>
                            <div class="know_credencials text-right">
                                <a href="{{ url('login') }}">I already know credential</a>
                            </div>
                        </form>
                        ...
                        <div class="card-links text-center mt-2">
                            ...
                            <span class="sep">|</span>
                            <a href="https://itassetmanagement.in/contact" target="_blank">Contact Us</a>
                        </div>
