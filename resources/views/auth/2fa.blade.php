...
@section('title', '2Factor Authentication')
            ...
            <div class="row g-0" style="min-height:100vh;">
                ...
                <div class="col-md-6 col-12 col-lg-6 col-xl-7 col-xxl-6 left-section">
                    ...
                    <div class="shadow-gradient">
                        <div class="slogan-text">
                            <h2>Revolutionizing Business with Tech</h2>
                            <p>ITM Software for Customer Relationship Management is available for sale, so you can get more
                                information.</p>
                ...
                <div class="col-12 col-lg-6 col-xl-5 col-xxl-6 auth-right">
                    ...
                    <div class="login-card">
                        ...
                        <p class="sub">Please enter the verification code</p>
                        ...
                        <form method="POST" action="{{ route('2fa.post') }}">
                            ...
                            @php
                                ...
                                $show2faMsg = !$hasError &&
                                    $settings->enable_2fa_authentication == 1 &&
                                    in_array($settings->enable_2fa_authentication_with, [1,2,3]);
                            @endphp

                            {{-- ALERT SECTION --}}
                            @if ($hasError)
                                <div class="alert alert-danger alert-dismissible fade show text-center mb-3">
                                    {{ Session::get('error') }}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                                </div>
                            @elseif ($show2faMsg)
                                <div class="alert alert-success alert-dismissible fade show text-center mb-3" role="alert">
                                    We sent you a code to your email/phone/mobile app.
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                                </div>
                            @endif
                            <div class="mb-2">
                                <input id="code" type="text" name="code" placeholder="Enter Code"  value="{{ old('code') }}" class="form-control auth-input @error('code') is-invalid @enderror" required autofocus>
                                <input type="hidden" name="userId" value="{{ session()->get('userId') }}">
                                <input type="hidden" name="impersonateId" value="{{ session()->get('impersonateId') }}">
                            ...
                            <div class="d-flex justify-content-end align-items-center mb-3 mt-1 remember-row">
                               <a href="{{ route('2fa.resend', ['userId' => session()->get('userId'), session()->get('impersonateId')]) }}"
                                    class="text-muted small">
                                    Resend Code?
                                </a>
                            </div>
                            <button type="submit" class="btn-continue btnContinue mb-2">
                        ...
                        <div class="card-links text-center mt-2">
                            <a href="https://greenitco.com/terms-for-use" target="_blank">Terms &amp; Conditions</a>
                            <span class="sep">|</span>
                            <a href="https://greenitco.com/contact-us" target="_blank">Contact Us</a>
                        </div>

                    </div>

                    <div class="auth-copyright mt-4">
                        &copy; {{ date('Y') }} GreenITCo Pvt Ltd | All Rights Reserved
                    </div>
...
<script type="text/javascript">
    ...
    setInterval(function() {
        $.get("{{ url('refresh-csrf') }}", function(data) {
