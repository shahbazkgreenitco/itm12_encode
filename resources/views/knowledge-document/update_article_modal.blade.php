{{-- * ------------------------------------------------------------
* File: update_article_modal.blade.php
...
* ------------------------------------------------------------ --}}
<div class="amg-modal amg-form-modal modal fade" id="articleupdateModal" tabindex="-1"
    aria-labelledby="vertical-center-modal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false"
    data-backdrop="static">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <form id="knowledge_document_update_form" name="knowledge_document_update_form" class="amg-form-theme"
                ...
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title" id="myLargeModalLabel">
                        {{ trans('content.knowledge_document.Update_Article') }}
                    </h3>
                    <button type="button" data-bs-dismiss="modal" data-dismiss="modal" class="modal-close"
                        aria-label="{{ trans('button.close') }}">
                            ...
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="status" id="status" class="form-select">
                                        <option value="">{{ trans('content.knowledge_document.select_status') }}</option>
                            ...
                            <div class="col-12 mb-3 mt-3 mb-xl-0">
                                <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="file" name="card_img" id="card_img"
                                            class="form-control form-input equal-width-text-input">
                                    </div>
                                    <div class="amg-form-error-wrap"></div>
                                </div>
                                <div class="amg-form-image-preview-wrap imgviewcover d-none d-flex flex-column">
                                    <div class="amg-form-image-preview">
                                        <img src="" id="imgview" class="amg-form-image-preview-img" alt="{{ trans('content.service_ticket_fields.Add_article_image') }}" />
                                    </div>
                                    <div class="kd-update-delete-image">
                                        <input type="checkbox" name="delete_img" class="row-checkbox form-check-input" id="delete_img" value="1" />
                                        <label for="delete_img">{{ trans('content.device_fields.delete_present_image') }}</label>
                                    </div>
                                </div>
                            ...
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- <div id="shows_error" class="mt-1"></div> --}}
                                    </div>
                                </div>
                                <div class="amg-form-error-wrap mt-1" id="shows_error"></div>
                            </div>
                        </div>

                        <div class="col-xl-12 row mt-2">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="update-dropper"
                                ...
                                <div class="input-group">
                                    <div class="col-md-12">
                                        <div id="update-dropper-cover" class="amg-uploader kd-update-uploader"
                                            ...
                                            data-record-input="#knowledge_document_update_form #tmp_id"
                                            data-upload-field="update_attachments">
                                            <input type="file" id="update_attachments" name="update_attachments"
                                                class="amg-uploader__input" multiple hidden>
                                            <div id="update-dropper" class="amg-uploader__dropzone">
                        ...
                        <div class="modal-footer">
                            <div class="amg-btn-group mt-3">
                                <button class="amg-btn amg-btn-secondary" id="btnClear" data-bs-dismiss="modal"
                                    data-dismiss="modal" type="button">{{ trans('config.kd_category_fields.cancel') }}</button>
                                <button type="button"
                                    class="amg-btn btn-submit-category amg-btn-primary js-act-update" id="btnUpdate">
                                    {{ trans('button.update') }}
                                </button>
                            </div>
                        </div>
...
<style>
    ...
    #articleupdateModal .input-group .form-select {
        min-height: 40px;
    }

    #articleupdateModal .select2-container--default .select2-selection--multiple {
    ...
    #articleupdateModal .select2-selection__rendered {
    ...
    #articleupdateModal .kd-update-delete-image {
        /* margin-left: 8.25rem; */
        margin-top: 0.5rem;
        display: flex;
        align-items: center;
