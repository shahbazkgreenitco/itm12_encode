...
@section('content')
    ...
    <section class="content">
            ...
            <div class="py-3">
                <div class="container-fluid">
                    <button onclick="location.href='{{ url('purchases') }}'"
                        ...
                        <h2 class="h2-text mb-0">{{ trans('content.download_format.purchase_import') }}</h2>
                    </button>
                </div>
            </div>
        </div>
                ...
                <ul class="nav nav-underline" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="info-tab-link" data-bs-toggle="tab" href="#info-tab" role="tab">
                            <span>{{ trans('config.purchase_fields.purchase_import') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="import-info-tab-link" data-bs-toggle="tab" href="#import-info-tab"
                            role="tab">
                            <span>{{ trans('config.purchase_fields.purchase_import_info') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
                            ...
                            <div class="col-12 col-sm-5">
                                <div class="drop-zone" id="dropZone">
                                    ...
                                    <div id="defaultState">
                                        ...
                                        <p class="drag-text mt-3 mb-2 b1-text">{{ trans("config.file_upload.drag_drop") }}
                                        </p>
                                        ...
                                        <span class="file-label b1-text">{{ trans("config.file_upload.no_file_selected")
                                            }}</span>
                                    </div>
        ...
        trans('suppliers_import.view.remove_file') }}</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-sm-7">
                                <div class="right-panel h-100">
                                    <a class="amg-btn amg-btn-white amg-btn-lg"
                                        href="{!! CommonHelper::asset('samples/PurchaseImportFormat.xlsx') !!}"
                                        target="_blank">
                                        ...
                                        <span class="font-weight-normal">Download Purchase Import Template</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="instructions-card mt-3">
                                ...
                                <div class="ps-3 ps-sm-4">
                                    ...
                                    <div class="card-scroll-body" id="cardScrollBody">
                                        ...
                                        <ul class="ps-3">
                                            <li>
                                                <span class="s1-text me-3">{{ trans("content.download_format.company") }}
                                                    <span class="mandatory"></span></span>
                                                <span class="b1-text text-muted">{{
        trans("config.user_import_fields.company_info") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text me-3">{{ trans("content.download_format.supplier") }}
                                                    <span class="mandatory"></span></span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.supplier_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text me-3">{{ trans("content.download_format.currency") }}
                                                    <span class="mandatory"></span></span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.currency_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text me-3">{{ trans("content.download_format.bill_amount")
                                                    }} <span class="mandatory"></span></span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.Bill_Amount_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.invoice_no")
                                                    }}</span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.invoice_number_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.location") }}</span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.location_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.po_number")
                                                    }}</span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.po_number_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text me-3">{{ trans("content.download_format.invoice_date")
                                                    }} <span class="mandatory"></span></span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.invoice_date_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.status") }}</span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.full_received_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.received_date")
                                                    }}</span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.received_date_field") }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.purchases_qty")
                                                    }}</span>
                                                <span class="b1-text text-muted">{{ trans("content.download_format.qty")
                                                    }}</span>
                                            </li>
                                            <li>
                                                <span class="s1-text">{{ trans("content.download_format.note") }}</span>
                                                <span class="b1-text text-muted">{{
        trans("content.download_format.note_field") }}</span>
                                            </li>
                                        </ul>
                                    </div>
...
@push('scripts')
    ...
    <script src="{!! CommonHelper::asset('js/purchase/purchase_import.js') !!}"></script>

    <script>
        var config = {};
        config.bulk_import_info = "{{ url('purchases/bulk-import-info')}}";
