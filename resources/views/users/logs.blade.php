{{-- @page-meta
{
  ...
  "versions": [
    ...
    },
    {
      ...
      "from": "2026-06",
      "reviewer": null,
      "description": "Changes for adding the back button for ui consistency"
    }
        ...
        <div class="container-fluid px-0">
            <div class="card rounded-0">
                    <div class="card-body">
                        ...
                        <!-- show select -->
                        <div class="col-auto">
                            <select class="amg-table-pagination-dropdown userModulePageLenth userlog-page-length">
                        ...
                        <div >
                            <div class="amg-list-searchbar">
                                <button type="button" class="amg-list-searchbar__icon-btn btn-searchbox" data-tab-key="accessories" aria-label="{{ trans('user.user_toolbar.search') }}" title="{{ trans('user.user_toolbar.search') }}">
                                ...
                                <input type="text" class="amg-list-searchbar__input searchbox" placeholder="Search..." autocomplete="off">
                            </div>
                        </div>

                        <!-- refresh button -->
                        <button type="button" class="amg-refresh-btn btn-reload-list" data-tab-key="accessories">
                    ...
                    <div class="table-responsive" style="overflow-y:hidden;">
                        <!-- table-striped -->
                        <table id="user-logs" class="amg-datatable table display" style="width:100%">
                            <thead>
                                <tr>
                                    <th>
                                        <h4>{{ trans('user.user_logs.table_activity') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('user.user_logs.table_logged_at') }}</h4>
                                    </th>
                                    <th>
                                        <h4>{{ trans('user.user_logs.table_updated_by') }}</h4>
                                    </th>
...
@endsection
@push('scripts')
<script src="{!! CommonHelper::asset('js/users/logs.js') !!}"></script>
<script type="text/javascript">
       $(document).ready(function () {
        var config ={};
        config.url={};
        config.url.list="{{ route('users-log-ajax') }}";
