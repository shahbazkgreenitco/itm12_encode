                ...
                <tbody>
                    @foreach($records as $d)
                        <tr>
                            ...
                            <td>{{ $d->email }} </td>
                            <td>{{ $d->phone_country_code ? (str_starts_with($d->phone_country_code, '+') ? $d->phone_country_code : '+' . $d->phone_country_code) : '' }} {{ $d->phone }}</td>
                            <td>{{ $d->job_type_text }} </td>
                            <td>{{ $d->ex_user_company }} </td>
                            <td>{{ $d->phone2_country_code ? (str_starts_with($d->phone2_country_code, '+') ? $d->phone2_country_code : '+' . $d->phone2_country_code) : '' }} {{ $d->phone2 }}</td>
                            <td>{{ $d->work_phone_country_code ? (str_starts_with($d->work_phone_country_code, '+') ? $d->work_phone_country_code : '+' . $d->work_phone_country_code) : '' }} {{ $d->work_phone }}</td>
                            <td>{{ $d->address }} </td>
