...
@section('title', trans("config.user_bulk_import_fields.user_bulk_update"))
            ...
            <div class="py-3">
                <div class="container-fluid ps-0">
                    <button onclick="location.href='{{ url('users') }}'"
                        ...
                        <h2 class="h2-text mb-0">{{ trans('config.user_bulk_import_fields.user_bulk_update') }}</h2>
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid pt-3 pb-5">
                @if (session('msg'))
                    <div class="alert customize-alert alert-dismissible alert-light-danger bg-danger-subtle text-danger fade show remove-close-icon"
                        ...
                        <div class="d-flex align-items-center me-3 gap-2 me-md-0">
                    ...
                    @if ($success > 0)
                        <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon"
                            ...
                            <div class="d-flex align-items-center me-3 gap-2 me-md-0">
                                ...
                                {{ $success }} user(s) updated successfully.
                            </div>
                        </div>
                    @endif
                    @if ($fail > 0)
                ...
                <div class="import-wrapper">
                    <div class="row g-3 align-items-stretch">
                        <div class="col-12 col-sm-3">
                            ...
                            <form id="importForm" method="POST" action="{{ url('users/bulk/update') }}"
                        ...
                        <div class="col-12 col-sm-9">
                            <div class="right-panel h-100">
                                @if (config('app.client') == 'ril' || config('app.client') == 'rolepermission')
                                    <a class="amg-btn amg-btn-white amg-btn-md" href="{!! CommonHelper::asset('samples/UserUpdateFormat1.xlsx') !!}"
                                        target="_blank">
                                        ...
                                        <span
                                            class="font-weight-normal">{{ trans('config.user_bulk_import_fields.download_user_update_template') }}</span>
                                    </a>
                                @else
                                    <a class="amg-btn amg-btn-white amg-btn-md" href="{!! CommonHelper::asset('samples/UserUpdateFormat.xlsx') !!}"
                                        target="_blank">
                                        <svg width="14" height="17" viewBox="0 0 14 17" fill="currentColor"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                    ...
                    <div class="col-12 px-3">
                        <div class="instructions-card mt-1">
                            <h4 class="b2-text" style="color:#7F7F7F">
                                {{ trans('config.user_bulk_import_fields.upload_notes_title') }}
                            </h4>
                            <div class="ps-3 ps-sm-4">
                                <p class="fst-italic b1-text mb-2">
                                    {{ trans('config.user_bulk_import_fields.note_excel_warning') }}
                                </p>
                                <div class="card-scroll-body" id="cardScrollBody">
                                    <ul class="ps-3">
                                        <li>
                                            <span class="b3-text me-3">
                                                {{ trans('config.user_bulk_import_fields.username') }} <span
                                                    class="mandatory"></span>
                                            </span>
                                            <span class="b5-text text-muted">
                                                {{ trans('config.user_bulk_import_fields.username_info') }}
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_import_fields.company') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_import_fields.company_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.first_name') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.first_name_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.last_name') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.last_name_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.email') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.email_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.designation') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.designation_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.alternate_phone_country_code') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.alternate_phone_country_code_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.alternate_phone') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.alternate_phone_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.phone_country_code') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.phone_country_code_info') }}</span>
                                        </li>
                                         <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.phone') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.phone_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.work_phone_country_code') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.work_phone_country_code_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.work_phone') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.work_phone_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.user_type') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.user_type_info') }}</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.employee_num') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.employee_num_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.location') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.location_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.address') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.address_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.notes') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.notes_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.manager') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.manager_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.department') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.department_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.activated') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.activated_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.seat_no') }}</span>
                                            <span
                                                class="b5-text text-muted">{{ trans('config.user_bulk_import_fields.seat_no_info') }}</span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.role') }}</span>
                                            <span class="b5-text text-muted">
                                                {{ trans('config.user_bulk_import_fields.role_info') }}
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.ticket_departments') }}</span>
                                            <span class="b5-text text-muted">
                                                {{ trans('config.user_bulk_import_fields.ticket_departments_info') }}
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.service_tickets_access') }}</span>
                                            <span class="b5-text text-muted">
                                                {{ trans('config.user_bulk_import_fields.service_tickets_access_info') }}
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.user_company') }}</span>
                                            <span class="b5-text text-muted">
                                                {{ trans('config.user_bulk_import_fields.user_company_info') }}
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">{{ trans('config.user_bulk_import_fields.technician_company_access') }}</span>
                                            <span class="b5-text text-muted">
                                                {{ trans('config.user_bulk_import_fields.technician_company_access_info') }}
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">Date of Joing</span>
                                            <span class="b5-text text-muted">
                                                field can be blank if you don't want to update it or else it must be format will (be dd-mm-yy)
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">Last working Date</span>
                                            <span class="b5-text text-muted">
                                                field can be blank if you don't want to update else it must be format will (be dd-mm-yy)
                                            </span>
                                        </li>
                                        <li>
                                            <span
                                                class="b3-text me-2">Internal Place</span>
                                            <span class="b5-text text-muted">
                                                Internal Place will be a child of the Location field. This field can be left blank if you don’t want to update it; otherwise, it must contain a valid name from Config > Internal Place.
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                <a class="amg-btn amg-btn-link amg-btn-link-plain" id="readMoreBtn">
                                    {{ trans('config.user_bulk_import_fields.read_more') }}
                                </a>
                            </div>
                        </div>
                    </div>
