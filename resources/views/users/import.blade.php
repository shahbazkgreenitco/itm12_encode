{{-- @page-meta
{
  ...
  "versions": [
    ...
    },
    {
      ...
      "from": "2026-05",
      "reviewer": null,
      "description": "Changes for the text in the first label not coming issue and import user format url changes"
    }
  ]
}
--}}
@extends('layouts.layout1')
@section('title', trans("config.user_import_fields.user_import"))
        ...
        <div class="py-3">
            <div class="container-fluid ps-0">
                <button class="d-flex gap-3 align-items-center bg-transparent outline-none border-0">
                    <svg onclick="window.location.href='{{ url('users') }}'" width="25" height="21" viewBox="0 0 25 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <h2 class="h2-text mb-0" style="cursor: default;">{{ trans("config.user_import_fields.user_import") }}</h2>
                </button>
            </div>
        </div>
    </div>
     ...
     <main class="main-content" id="mainContent">
        ...
        <div class="container-fluid pt-3 pb-5">
            ...
            @if(isset($success) || isset($fail))
                ...
                @if($success > 0)
                    <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon" role="alert">
                        ...
                        <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                            ...
                            {{ $success }} user(s) imported successfully.
                        </div>
                    </div>
                @endif
                ...
                @endif
                @if($success == 0 && $fail == 0 && count($fail_msgs) > 0)
            ...
            <div class="import-wrapper">
                ...
                <div class="row g-3 align-items-stretch">
                    <div class="col-12 col-sm-3">
                        ...
                        <form id="importForm" method="POST" action="{{ url('users-import') }}" enctype="multipart/form-data" style="display:none;">
                            @csrf
                    ...
                    <div class="col-12 col-sm-9">
                        <div class="right-panel h-100">
                            @if(config('app.client') == "ril" || config('app.client') == "rolepermission")
                                <a class="amg-btn amg-btn-white amg-btn-md" href="{!! CommonHelper::asset('samples/UserImportFormat.xlsx') !!}" target="_blank">
                                    ...
                                    <span class="font-weight-normal">{{ trans("config.user_import_fields.download_user_import_template") }}</span>
                                </a>
                                @else
                                <a class="amg-btn amg-btn-white amg-btn-md" href="{!! CommonHelper::asset('samples/UserImportFormat.xlsx') !!}" target="_blank">
                                    <svg width="14" height="17" viewBox="0 0 14 17" fill="currentColor"
                ...
                <div class="col-12 px-3">
                    ...
                    <div class="instructions-card mt-1">
                        ...
                        <h4 class="b2-text" style="color:#7F7F7F" >
                            {{ trans("config.user_import_fields.upload_notes_title") }}
                        </h4>
                
                        <div class="ps-3 ps-sm-4">

                            <p class="fst-italic b1-text mb-2">
                                {{ trans("config.user_import_fields.note_footer") }}
                            </p>
                            ...
                            <div class="card-scroll-body" id="cardScrollBody">
                                <ul class="ps-3">
                                    <li>
                                        <span class="b3-text me-3">{{ trans("config.user_import_fields.company") }} <span class="mandatory"></span></span>
                                        <span class="b1-text text-muted">{{ trans("config.user_import_fields.company_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text me-3">{{ trans("config.user_import_fields.first_name") }} <span class="mandatory"></span></span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.first_name_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text me-3">{{ trans("config.user_import_fields.last_name") }} <span class="mandatory"></span></span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.last_name_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text me-3">{{ trans("config.user_import_fields.username") }} <span class="mandatory"></span></span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.username_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.email") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.email_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.password") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.password_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.activated") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.activated_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text me-3">{{ trans("config.user_import_fields.location") }} <span class="mandatory"></span></span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.location_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.phone_country_code") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.phone_country_code_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.phone") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.phone_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.user_type") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.user_type_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.external_user_company_name") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.external_user_company_name_info") }}</span>
                                    </li>
                                     <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.phone2_country_code") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.phone2_country_code_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.alternate_phone") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.alternate_phone_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.work_phone_country_code") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.work_phone_country_code_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.work_phone") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.work_phone_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.address") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.address_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.designation") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.designation_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.employee_num") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.employee_num_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.notes") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.notes_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.department") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.department_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.role") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.role_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("config.user_import_fields.seat_no") }}</span>
                                        <span class="b5-text text-muted">{{ trans("config.user_import_fields.seat_no_info") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.ticket_departments") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.ticket_departments_desc") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.service_tickets_access") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.service_tickets_access_desc") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.user_company") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.user_company_desc") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.technician_company_access") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.technician_company_access_desc") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.date_of_joining") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.date_of_joining_desc") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.last_working_date") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.last_working_date_desc") }}</span>
                                    </li>
                                    <li>
                                        <span class="b3-text">{{ trans("content.download_format.internal_place") }}</span>
                                        <span class="b5-text text-muted">{{ trans("content.download_format.internal_place_desc") }}</span>
                                    </li>
                                </ul>
                            </div>
...
@push('scripts')
   <script>
        ...
        $('#btnSave').on('click', function (e) {
            ...
            if (!['xlsx', 'xls'].includes(ext)) {
                Swal.fire({
                    icon: "error",
                    title: "Invalid File",
                    text: "Please upload an .xlsx or .xls file.",
        ...
        setTimeout(function () {
            document.querySelectorAll('.customize-alert').forEach(function (el) {
        ...
        $('#readMoreBtn').on('click', function (e) {
            ...
            if (expanded) {
                ...
                $(this).text("{{ trans('config.user_bulk_import_fields.read_more') }}");
