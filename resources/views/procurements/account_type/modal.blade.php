...
* ------------------------------------------------------------ --}}
<div id="accountTypeMdl" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="locationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered w-50">
        <form id="AccountTypeForm" name="AccountTypeForm" method="post" action="#" autocomplete="off" class="w-100 amg-form-theme" onsubmit="return false;">
            @csrf
            ...
            <div class="modal-content rounded-5">
                    ...
                    <div class="container-fluid py-3">
                        ...
                        <div class="row mb-4 px-4">
                            <div class="col-md-12">
                                <div class="amg-form-field-row">
                                    <div class="amg-form-field d-flex align-items-center">
                                        <label class="form-label b1-text me-2 mb-0 text-end required">{{ trans("config.procurAccountType_fields.name") }}</label>
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="bi bi-tag"></i></span>
                                            <input type="text" name="name" id="name" class="form-control" placeholder="{{ trans('config.procurAccountType_fields.enter_name') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer px-4 pb-4">
                    ...
                    <button type="button" class="amg-btn amg-btn-secondary" data-bs-dismiss="modal">{{ trans("button.close") }}</button>
                </div>
