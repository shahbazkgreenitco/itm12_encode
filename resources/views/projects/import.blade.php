...
@section('title', trans('projects_import.view.header'))
        ...
        <div class="header-actions-wrapper header-actions-white-wrapper d-flex align-items-center justify-content-between pe-4">
            <div class="py-3">
                <div class="container-fluid ps-0">
                    <button onclick="location.href='{{ url('projects/list') }}'"
                        ...
                        <h2 class="h2-text mb-0">{{ trans('projects_import.view.page_heading') }}</h2>
                    </button>
                </div>
            </div>
        </div>
                ...
                <ul class="nav nav-underline" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="info-tab-link" data-bs-toggle="tab" href="#info-tab" role="tab">
                            <span>{{ trans('projects_import.view.bulk_projects_import') }}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="import-info-tab-link" data-bs-toggle="tab" href="#import-info-tab" role="tab">
                            <span>{{ trans('projects_import.view.bulk_projects_import_info') }}</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="tab-pane fade show active container-fluid pt-3 pb-5" id="info-tab">
                    ...
                    <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon" role="alert">
                        ...
                        <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                            ...
                            {{ session('success', 0) }} {{ trans('projects_import.view.projects_imported_successfully') }}
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="alert customize-alert alert-dismissible alert-light-danger bg-danger-subtle text-danger fade show remove-close-icon" role="alert">
                        ...
                        <div class="d-flex align-items-start me-3 gap-3 me-md-0">
                            ...
                            <div>
                                {{ session('fail', 0) }} {{ trans('projects_import.view.projects_failed_import') }}
                    ...
                    <div class="alert customize-alert alert-dismissible alert-light-warning bg-warning-subtle text-warning fade show remove-close-icon" role="alert">
                        ...
                        <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                            ...
                            {{ trans('projects_import.view.no_projects_imported') }}
                        </div>
                    </div>
                    @endif
                    @endif
                        ...
                        <div class="row g-3 align-items-stretch">
                            <div class="col-12 col-sm-3">
                                <div class="drop-zone" id="dropZone">
                                    ...
                                    <div id="defaultState">
                                        ...
                                        <p class="drag-text mt-2 mb-1">{{ trans('projects_import.view.drag') }}
                                            &amp; {{ trans('projects_import.view.drop_here') }}</p>
                                        <button class="amg-btn amg-btn-secondary upload-doc-btn">
                                            ...
                                            <span>{{ trans('projects_import.view.upload_file') }}</span>
                                        </button>
                                        <span class="file-label">{{ trans('projects_import.view.files_selected') }}</span>
                                    </div>
                                    ...
                                    <div id="selectedState" style="display:none;">
                                        ...
                                        <button class="amg-btn amg-btn-link amg-btn-link-plain p-0"
                                            id="btnRemove">{{ trans('projects_import.view.remove_file') }}</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-sm-9">
                                <div class="right-panel h-100">
                                    <a class="amg-btn amg-btn-white amg-btn-md" href="{!! CommonHelper::asset('samples/ProjectImportFormat.xlsx') !!}"
                                        target="_blank">
                                        ...
                                        <span
                                            class="font-weight-normal">{{ trans('projects_import.view.download_template_button') }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 px-3">
                            ...
                            <div class="instructions-card mt-1">
                                ...
                                <h4 class="b2-text" style="color:#7F7F7F">
                                    {{ trans('projects_import.view.read_notes') }}
                                </h4>
                                ...
                                <div class="ps-3 ps-sm-4">
                                    ...
                                    <div class="card-scroll-body" id="cardScrollBody">
                                        <ul class="ps-3">
                                            <li>
                                                <span class="b3-text me-3">{{ trans('projects_import.view.name') }}
                                                    <span class="mandatory"></span></span>
                                                <span
                                                    class="b5-text text-muted">{{ trans('projects_import.view.name_text') }}</span>
                                            </li>

                                            <li>
                                                <span
                                                    class="b3-text">{{ trans('projects_import.view.project_head') }}</span>
                                                <span
                                                    class="b5-text text-muted">{{ trans('projects_import.view.project_head_text') }}</span>
                                            </li>

                                            <li>
                                                <span
                                                    class="b3-text">{{ trans('projects_import.view.start_date') }}</span>
                                                <span
                                                    class="b5-text text-muted">{{ trans('projects_import.view.start_date_text') }}</span>
                                            </li>
                                            <li>
                                                <span
                                                    class="b3-text">{{ trans('projects_import.view.description') }}</span>
                                                <span
                                                    class="b5-text text-muted">{{ trans('projects_import.view.description_text') }}</span>
                                            </li>

                                            <li>
                                                <span
                                                    class="b3-text">{{ trans('projects_import.view.project_no') }}</span>
                                                <span
                                                    class="b5-text text-muted">{{ trans('projects_import.view.project_no_text') }}</span>
                                            </li>
                                            <li>
                                                <span class="b3-text">{{ trans('projects_import.view.company') }}</span>
                                                <span
                                                    class="b5-text text-muted">{{ trans('projects_import.view.company_text') }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <h4 class="b2-text" style="color:#7F7F7F">
                                    {{ trans('projects_import.view.change_first_row') }}
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-2 mb-1" data-select2-id="select2-data-5-1om7">
                                ...
                                <div id="customLengthContainer" class="col-auto" data-select2-id="select2-data-4-sbib">
                                    <select id="showSelect"
                                        ...
                                        <option value="10" selected>{{ trans('projects_import.view.show') }} (10)
                                        </option>
                                        <option value="25">{{ trans('projects_import.view.show') }} (25)</option>
                                        <option value="50">{{ trans('projects_import.view.show') }} (50)</option>
                                        <option value="100">{{ trans('projects_import.view.show') }} (100)</option>
                                    </select>
                                </div>
                                ...
                                <div style="width: 280px;">
                                    <div class="amg-list-searchbar">
                                        ...
                                        <input type="text" class="amg-list-searchbar__input" id="tableSearch"
                                            placeholder="{{ trans('projects_import.view.search') }}...">
                                    </div>
                                </div>
                                ...
                                <button class="amg-refresh-btn btn-reload-list">
                                    ...
                                    <span>{{ trans('projects_import.view.refresh') }}</span>
                                </button>
                            </div>
                            <table id="tblHistory" class="table display">
                                <thead>
                                    <tr>
                                        <th>
                                            <h4>{{ trans('projects_import.table.id') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.document_name') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.total_upload') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.total_success') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.total_failure') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.updated_at') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.username') }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans('projects_import.table.actions') }}</h4>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
...
<script src="{!! CommonHelper::asset('js/projects/project_import.js') !!}"></script>

<script>
    var config = {};
    config.bulk_import_info = "{{ url('projects/bulk-import-info')}}";
    config.document_download = "{{ url('uploads/bulk_documents') }}";
    config.token = "{{ csrf_token() }}";
    config.translations = {
        Download_Document: '{{ trans('    projects_import.config.Download_Documents ') }}',
        search: '{{ trans('    projects_import.config.search ') }}',
        reload: '{{ trans('    projects_import.config.reload ') }}',
        please_enter_valid_search: '{{ trans('    projects_import.config.please_enter_valid_search ') }}',
        import_file: "{{ trans('projects_import.config.import_file') }}",
        Please_upload_valid_xlsx: "{{ trans('projects_import.config.upload_valid') }}",
    };
