...
@section('title', 'View Status Form')
                    ...
                    <div class="srd-form-row">
                        ...
                        <div class="srd-form-value">
                            ...
                            @if(!is_array($v['fieldValue']))
                                ...
                                @else
                                    <div class="text-dark">{!! $v['fieldValue'] !!}</div>
                                @endif
                            ...
                            @else
                                ...
                                @foreach($v['fieldValue'] as $key => $val)
                                    ...
                                    {{-- Badge values (select, radio, checkbox, etc.) --}}
...
{{-- <link href="{!! CommonHelper::asset('css/ticket.css') !!}" rel="stylesheet" /> --}}
<style>
    /* =========================
   SRD FORM VIEW CARD - MODERN
   ========================= */
.srd-form-view-card {
    background: #fff;
...
.srd-attachment-actions a,
.srd-attachment-actions span {
    color: #6b7280;
    text-decoration: none;
    cursor: pointer;
}
.srd-attachment-actions a:hover,
.srd-attachment-actions span:hover {
    color: #111827;
}
...
<script src="{!! CommonHelper::asset('js/jquery-ui.min.js') !!}"></script>
