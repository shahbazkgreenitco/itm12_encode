...
* ------------------------------------------------------------
* Change Log:
* [1.0.2] - Changes for the required icon showing twice issues and modal button placement changes - prithvi - 7/23/26
...
<div id="holidaysMdl" class="amg-modal modal fade user-mdl-box relevant-ticket-mdl-box" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <form id="DeviceType" name="DeviceType" method="post" action="#" class="form-horizontal w-100"
            onsubmit="return false;">
            <div class="modal-content rounded-5">
                {{-- modal head --}}
                <div class="modal-header">
                    <h3 class="modal-title px-4" id="locationModalLabel">
                        {{ trans('device_type.modal.add_device_type_header') }}
                    </h3>
                            ...
                            <div class="row g-4 px-4">
                                <div class="col-md-12 amg-form-field-row">
                                    <label class="form-label b1-text mb-2">
                                        {{ trans('device_type.modal.device_type_name') }} <span
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" id="name" class="form-control"
                                            placeholder="{{ trans('device_type.modal.device_type_name_placeholder') }}"
                                            required>
