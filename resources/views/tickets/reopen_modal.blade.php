{{-- Ticket Reopen Modal Popup --}}

<div id="mdl-reopen" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div id="mdl_popup_loader"></div>
    <div class="modal-dialog modal-dialog-centered">
        <form id="frm_reopen" name="frm_reopen" method="post" action="#" class="form-horizontal">
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title">
                        {{ trans('content.service_ticket_fields.Ticket_Reopen') }}
                    </h3>
                    ...
                    <div class="row mb-0 mb-xl-3 px-4">
                        <div class="col-12">
                            <div class="amg-form-field">
                                <label for="comment" class="form-label b1-text required">
                                    {{ trans('content.service_ticket_fields.share') }}
                                </label>
                                <textarea id="comment" name="comment" class="form-control textarea" rows="5"
                                    placeholder="Please share your reason here"></textarea>
