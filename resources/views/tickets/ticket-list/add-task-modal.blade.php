        ...
        <form id="task" name="task" method="POST" action="#" class="form-horizontal"
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-body">
                    <div class="row">
                        <!-- Company -->
                        <div class="row align-items-center mb-3 amg-form-field-row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group ticket-input-group">
                                    ...
                                    <select id="company" name="company_id" readonly class="form-select filter-input form-with-icon">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center mb-3 amg-form-field-row d-none">
                            ...
                            <div class="col-md-9">
                                <div class="input-group ticket-input-group">
                                    ...
                                    <select name="status_id" id="task_edit_status_id"
                        ...
                        <!-- Sub Category -->
                        <div id="task_sub_category_id_cvr" class="row align-items-center mb-3 amg-form-field-row">
                        ...
                        <div class="row align-items-start mb-3 amg-form-field-row">
                            ...
                            <div class="col-md-9">
                                <textarea id="task_description" name="description" class="w-100">
                                </textarea>
                            </div>
                        </div>
