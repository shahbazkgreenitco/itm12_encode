...
"from": "2026-05",
"reviewer": null,
"description": "delete ticket modal"
}
]
}
--}}
<div class="amg-modal amg-form-modal modal modal-lg fade" id="mdlDeleteTicket" tabindex="-1"
    aria-labelledby="mdlDeleteTicketLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <form id="edit-ticket-mdl-frm" class="form-horizontal w-100 amg-form-theme" autocomplete="off"
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    <h3 class="modal-title s1-text fw-bold px-2" id="customStatusModalTitle">{{ trans('ticket.update_status.are_you_sure_on_delete') }}</h3>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row mb-4 amg-form-field-row px-3">
                            <label for="delete-reason"
                                class="form-label b3-text fw-bold required mb-1 ps-0">{{ trans('ticket.create_ticket.reason') }}</label>
                            <textarea name="delete-reason" id="delete-reason" class="amg-summernote"
                                placeholder="{{ trans('ticket.create_ticket.enter_your_message') }}"></textarea>
                ...
                <div class="amg-form-footer gap-2 modal-footer d-flex justify-content-end py-4">
                    ...
                    <button type="button" id="btndelsubmit"
