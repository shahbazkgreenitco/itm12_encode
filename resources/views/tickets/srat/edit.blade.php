...
@section('title', trans("content.ticket_procurement.Edit_PAB"))
@section('content')
...
<div id="srat-group-list-wrapper">
    ...
    <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
        <button type="button" class="bg-transparent border-0 d-flex align-items-center gap-2"
            ...
            <h3 class="h3-text mb-0">{{ trans("content.ticket_procurement.Edit_PAB") }} -{{ $pab->name }}</h3>
        </button>
    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-body p-4">
                    <form name="cab"
                          method="POST"
                          id="addForm"
                          action="{{ url('tickets/pab/edit', ['id' => $pab->id]) }}">
                        ...
                        <div class="row mb-4 align-items-center">
                            <label for="name"
                                   class="col-md-3 col-form-label text-md-end fw-semibold mandatory">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text"
                                       ...
                                       id="name"
                                       class="form-control"
                                       placeholder="{{ trans("content.ticket_procurement.Name_PH") }}"
                                       value="{{ $pab->name }}" />
                                </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <textarea name="description"
                                          ...
                                          rows="4"
                                          class="form-control"
                                          placeholder="{{ trans("content.ticket_procurement.Description_PH") }}">{{ $pab->description }}</textarea>
                                </div>
                        ...
                        <div class="row mb-4 align-items-center">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <select id="hierarchy_approval"
                                            name="hierarchy_approval"
                                            class="form-select">
                                        <option value="3" @if($pab->hierarchy_approval == 3) selected @endif>
                                            Group Approval
                                        </option>
                                        <option value="1" @if($pab->hierarchy_approval == 1) selected @endif>
                                            Level By Level
                                        </option>
                                        <option value="2" @if($pab->hierarchy_approval == 2) selected @endif>
                                            Minimum Approval
                                        </option>
                                        <option value="4" @if($pab->hierarchy_approval == 4) selected @endif>
                                            Manager Approval
                                        </option>
                                        <option value="5" @if($pab->hierarchy_approval == 5) selected @endif>
                                            Location Approval
                                        </option>
                                        <option value="8" @if($pab->hierarchy_approval == 8) selected @endif>
                                            System Approval
                                        </option>

                                        @if(in_array(config('app.client'), ["ltts", "rolepermission"]))
                                            <option value="9" @if($pab->hierarchy_approval == 9) selected @endif>
                                                DU Head Approval
                                            </option>
                                            <option value="10" @if($pab->hierarchy_approval == 10) selected @endif>
                                                BU Head Approval
                                            </option>
                                            <option value="13" @if($pab->hierarchy_approval == 13) selected @endif>
                                                BU/DU Head Approval
                                            </option>
                                            <option value="14" @if($pab->hierarchy_approval == 14) selected @endif>
                                                DU/BU Head Approval
                                            </option>
                                        @endif

                                        <option value="11" @if($pab->hierarchy_approval == 11) selected @endif>
                                            Department Head Approval
                                        </option>
                                        <option value="12" @if($pab->hierarchy_approval == 12) selected @endif>
                                            Next Level Manager Approval
                                        </option>
                                    </select>
                                </div>
                        ...
                        <!-- Minimum Approval -->
                        <div class="row mb-4 cover @if($pab->hierarchy_approval != 2) d-none @endif">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="number"
                                       name="required_minimum_approvals"
                                       id="required_minimum_approvals"
                                       class="form-control"
                                       value="{{ $pab->required_minimum_approvals ? $pab->required_minimum_approvals : 1 }}" />
                                </div>
                        ...
                        <div class="row">
                            <div class="offset-md-3 col-md-9 d-flex gap-2">
                                <button class="amg-btn amg-btn-primary amg-btn-md mb-2"
                                        id="btnSubmit"
                                        type="submit">
                                    {{ trans("button.update") }}
                                </button>
                                <button class="amg-btn amg-btn-secondary amg-btn-md mb-2 ms-2"
                                        id="cancel"
                                        type="button">
                                    {{ trans("button.cancel") }}
                                </button>
...
$(document).ready(function () {
    $(".go-list, #cancel").on("click", function () {
        window.location = '{{ url("tickets/pab/list") }}';
    });
    var config = {};
    config.url = {};
    ...
    config.member_count = "{{ count($pab->members) }}";
