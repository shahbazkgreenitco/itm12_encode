<div class="amg-modal amg-filter-modal modal fade show" id="sratFilterModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="modal-content rounded-5 bg-white">
            ...
            <div class="modal-body">
                <div class="row g-3 mt-8 px-4">
                    <div class="col-md-3">
                        <label class="form-label b1-text">{{ trans('content.filter_heading.filter_by_company') }}</label>
                        <select class="form-control" id="filter_by_company" name="filter_by_company[]" multiple></select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label b1-text">{{ trans("content.service_ticket_fields.approval_mode") }}</label>
                        <select name="filter_by_approver" id="filter_by_approver" class="form-control">
                    ...
                    <div class="col-md-3">
                        <label class="form-label b1-text">Filter By Srat Member</label>
                        <select class="form-control" id="filter_by_member" name="filter_by_member[]" multiple></select>
                    </div>
                </div>
            </div>
