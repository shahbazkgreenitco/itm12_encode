<div id="mdlDeleteTicket" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div id="mdl_popup_loader"></div>
    <div class="modal-dialog modal-dialog-centered">
        <form id="deleteTicketForm" name="delete_ticket_form" method="post" action="#" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center">
                    <h3 class="b1-text">{{ trans("ticket.ticket_detail.delete_ticket_confirm") ?? 'Are you sure you want to delete this ticket?' }}</h3>
                    ...
                    <div class="row mb-0 mb-xl-3 px-4">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="delete-reason" class="form-label b4-text me-2 mb-0 text-end required">{{ trans("ticket.ticket_detail.delete_reason") ?? 'Add Reason' }}</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-chat-text"></i></span>
                                    <textarea name="delete-reason" id="delete-reason" class="form-control amg-summernote" placeholder="{{ trans('ticket.ticket_detail.delete_reason_placeholder') ?? 'Enter a reason for deletion' }}" rows="3"></textarea>
                                </div>
                ...
                <div class="modal-footer">
                    <div class="amg-btn-group mt-3">
                        <button type="submit" id="btndelsubmit" class="amg-btn amg-btn-primary">{{ trans("button.submit") }}</button>
