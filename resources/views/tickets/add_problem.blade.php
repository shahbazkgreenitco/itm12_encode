  ...
  "versions": [
    {
      ...
      "from": "2026-05",
      "reviewer": null,
      "description": "Initial Problme Management Page Design"
    }
  ]
}
--}}
<div id="addproblemModal" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-5">
            <form name="problem-mdl-frm" id="addproblem-mdl-frm" method="post" action="#" class="form-horizontal" enctype="multipart/form-data">
                <input type="hidden" name="_token" id="token" class="hidden" value=""/>
                <input type="hidden" name="ticket_id" id="ticket_id" class="hidden" value=""/>
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title s1-text fw-semibold mb-0"></h3>
                ...
                <div class="modal-body">
                        ...
                        <div class="row g-4 px-4">
                            <div class="col-12">
                                <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                    <label for="problem_mgt" class="form-label b5-text me-2 mb-0 text-end">{{ trans("Select Problem") }}</label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi bi-question-circle"></i></span>
                                        <select id="problem_mgt" name="problem_mgt" class="form-control"></select>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="amg-btn-group mt-3">
                            <button type="submit" id="btnSubmit" class="amg-btn amg-btn-primary">{{ trans("content.service_ticket_fields.ticket_problem_mgt") }}</button>
