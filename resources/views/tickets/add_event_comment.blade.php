{{-- Ticket book_calendar Modal Popup --}}
<div id="add_event_comment" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div id="mdl_popup_loader"></div>
    <div class="modal-dialog modal-dialog-centered">
        <form id="add-event-comment-mdl-frm" name="add-event-comment-mdl-frm" method="post" action="#" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="_token" id="token" class="hidden" value=""/>
            <input type="hidden" name="id" id="event_id" value="">
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title">Add Comment/Update</h3>
                    ...
                    <div class="row mb-0 mb-xl-3 px-4">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="event_status" class="form-label b1-text me-2 mb-0 text-end required">{{ trans('ticket.book_calender.Status') }}</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-flag"></i></span>
                                    <select name="event_status" id="event_status" class="form-control error_shows">
                    ...
                    <div class="row mb-0 mb-xl-3 px-4">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-start">
                                <label for="comment" class="form-label b1-text me-2 mb-0 text-end required pt-2">{{ trans('ticket.book_calender.comment') }}</label>
                                <div class="input-group flex-column">
                                    <div class="w-100">
                                        <textarea class="summernote form-control" name="comment" id="comment"></textarea>
                                    </div>
                                    <div id="shows_error" class="amg-form-error-wrap mt-1"></div>
                                </div>
                            </div>
                        </div>
                    </div>
