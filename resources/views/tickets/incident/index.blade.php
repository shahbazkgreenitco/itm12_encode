...
@section('title', trans("content.ticket_incident.ticket_incident"))
@section('content')
    <div id="ticket-incident-list-wrapper">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <h3 class="h3-text mb-0">{{ trans("content.ticket_incident.ticket_incident") }}</h3>
            <div class="d-flex gap-8">
                ...
                <button class="amg-btn amg-btn-primary amg-btn-sm btn-add-incident" type="button" data-bs-toggle="tooltip"
                    title="{{ trans('content.ticket_incident.add_new_incident') }}">
                    ...
                    <span>{{ trans('content.ticket_incident.add_new_incident') }}</span>
                </button>
                @endif
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-2 mb-1">
                            <div class="col-auto">
                                <select class="amg-table-pagination-dropdown amgTablePageLenth incident-list-page-length">
                                    <option value="10" selected>{{ trans('ticket_incident.ticket_incident.show') }} (10)</option>
                                    <option value="25">{{ trans('ticket_incident.ticket_incident.show') }} (25)</option>
                                    <option value="50">{{ trans('ticket_incident.ticket_incident.show') }} (50)</option>
                                    <option value="100">{{ trans('ticket_incident.ticket_incident.show') }} (100)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                <div class="amg-list-searchbar">
                                    ...
                                    <input type="text" class="amg-list-searchbar__input user-list-search"
                                        placeholder="{{ trans('ticket_incident.ticket_incident.search') }}">
                                </div>
                            </div>
                        ...
                        <div class="">
                            <div class="table-responsive">
                                <table id="ticket-incident" class="amg-datatable table display app-data-table">
                                    <thead>
                                        <tr>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.id') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.subject') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.company') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.Tickets') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.department_impacted') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.Creator') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.problem_category') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.sub_category') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.priority') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.financial_loss_amount') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.man_hour_loss') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.service_impacted') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.sla_breahced') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.internal_place') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.location') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.content') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.rca') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.why_incident_happened') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.preventive_measure_taken') }}</h4>
                                            </th>
                                            <th>
                                                <h4>RCA {{ trans('content.ticket_incident.status') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.status') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.incident_start_date_time') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.incident_end_date_time') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.ticket_incident.Updated_At') }}</h4>
                                            </th>
                                            <th>
                                                <h4>{{ trans('content.service_ticket_fields.Actions') }}</h4>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        @include('tickets.incident.read-more-modal')
        @include('tickets.incident.incident-filter')
        @include('tickets.incident.add-incident')        
    </div>
@endsection
...
@push('css')
    ...
    <style>
        ...
        #ticket-incident-list-wrapper #readMoreModalBody {
        ...
        #incident-mdl-frm .note-editor {
            width: 100% !important;
            max-width: 100% !important;
        }

        #incident-mdl-frm .amg-form-field label.error {
            display: block !important;
            width: 100% !important;
            margin-top: 4px !important;
            margin-left: calc(130px + 8px) !important;
        }
        #incident-mdl-frm .container-fluid{
            max-height: 500px;
            overflow-y: auto;
        }
        #incident-mdl-frm .container-fluid {
        ...
        #incident-mdl-frm .container-fluid::-webkit-scrollbar {
            width: 6px;
        }

        #incident-mdl-frm .container-fluid::-webkit-scrollbar-track {
            background: transparent;
            margin-block: 25px;
        }

        #incident-mdl-frm .container-fluid::-webkit-scrollbar-thumb {
            background-color: #c1c1c1;
            border-radius: 10px;
        }

        #incident-mdl-frm .container-fluid::-webkit-scrollbar-thumb:hover {
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            config.url.incident_list = "{{ url('jx-incident-list') }}";
            // config.is_super_user = {{ Auth::user()->isSuperUser() }};
            config.url.getTicketDetails = "{{ url('tickets/getTicketDetails') }}";
            ...
            config.url.save = "{{ url('tickets/initIncident') }}";
            config.url.delete = "{{ url('tickets/deleteincident/delete') }}";
            config.url.edit = "{{ url('tickets/editincident/edit') }}";
            config.url.view = "{{ url('tickets/viewincident/view') }}";
            config.url.download_url = "{{ url('export-incident') }}";
            ...
            config.url.ajaxGetInternalPlace = "{{ url('ajaxGetInternalPlace') }}";
            config.url.attachment_download = "{{ url('tickets/attachment/download') }}";
            config.url.download_pdf = "{{ url('tickets/exportTicketIncidentPDF') }}";
            config.url.download_modal_pdf = "{{ url('tickets/exportTicketIncidentModalPDF') }}";
            ...
            config.url.create_incident = "{{ url('tickets/createIncident') }}";
            config.url.incident_attachment_add = "{{ url('tickets/attachment/incident_attachment') }}";
            config.url.incident_attachment_remove = "{{ url('tickets/attachment/incident_attachment_remove') }}";
            config.url.departments_based_on_privilage = "{{ url('departments/by-company/privilage') }}";
            config.url.ticketDetails = "{{ url('tickets/incident/getTicketDetails') }}";
            ...
            config.user = {!! json_encode(Auth::user()->only('id', 'first_name', 'last_name', 'username', 'company_id', 'displayName')) !!};
            config.token = "{{ csrf_token() }}";
            config.translations = {
                preventive_measure_taken: '{{ trans('content.ticket_incident.preventive_measure_taken') }}',
                content: '{{ trans('content.service_ticket_fields.Content') }}',
                why_incident_happened: '{{ trans('content.ticket_incident.why_incident_happened') }}',
                rca: '{{ trans('content.ticket_incident.rca') }}',
                something_went_wrong: '{{ trans('content.user_fields.something_went_wrong') }}',
                add_new_incident: '{{ trans('content.ticket_incident.add_new_incident') }}',
                edit_incident: '{{ trans('content.ticket_incident.edit_incident') }}',
                view_incident: '{{ trans('content.ticket_incident.view_incident') }}',
                save: '{{ trans('button.save') }}',
                placeholder: '{{ trans('content.ticket_incident.search_option') }}',
                View: '{{ trans('content.ticket_incident.View') }}',
                Edit: '{{ trans('content.ticket_incident.Edit') }}',
                Delete: '{{ trans('content.ticket_incident.Delete') }}',
                View_Config: '{{ trans('content.service_ticket_fields.View_Config') }}',
                Select_Problem_Category: '{{ trans('content.ticket_incident.Select_Problem_Category') }}',
                Select_Sub_Category: '{{ trans('content.ticket_incident.Select_Sub_Category') }}',
                ...
                Search: '{{ trans('content.ticket_incident.Search') }}',
                Add_Trigger: '{{ trans('content.schedular_listing_fields.Add_Trigger') }}',
                Refresh_List: '{{ trans('content.ticket_incident.Refresh_List') }}',
                Download: '{{ trans('content.ticket_incident.Download') }}',
                New_incident: '{{ trans('content.ticket_incident.New_incident') }}',
                connect: '{{ trans('content.ticket_incident.connect') }}',
                enter_first_few_letter: '{{ trans('content.ticket_incident.enter_first_few_letter') }}',
                select_device: '{{ trans('content.ticket_incident.select_device') }}',
                select_reply_to_account: '{{ trans('content.ticket_incident.select_reply_to_account') }}',
                select_priority: '{{ trans('content.ticket_incident.select_priority') }}',
                Download_Pdf: '{{ trans('content.ticket_incident.Download_Pdf') }}',
                delete_record: '{{ trans('content.ticket_incident.delete_record') }}',
                Update: '{{ trans('content.ticket_incident.Update') }}',
                Export_PDF: '{{ trans('content.ticket_incident.Export_PDF') }}',
                create: '{{ trans('button.create') }}',
                No_Filter: '{{ trans('content.network_inv_fields.No_Filter') }}',
                please_select_option: '{{ trans('content.ticket_incident.please_select_option') }}',
                ...
                filter_by_ticket_incident_rca_status: '{{ trans('content.filter_heading.filter_by_ticket_incident_rca_status') }}',
                comment_summer: '{{ trans('content.ticket_incident.Notes') }}',
                upload_file: '{{ trans('content.service_ticket_fields.upload_file') }}',
                filter_by_creator: '{{ trans('content.ticket_incident.filter_by_creator') }}',
                filter_by_sla_breached: '{{ trans('content.ticket_incident.filter_by_sla_breached') }}',
                enter_service_impacted: '{{ trans('content.ticket_incident.enter_service_impacted') }}',
            };
            config.taskModule = {{ config('services.task_module.enabled') ? 1 : 0 }};
            new TicketIncident(config);
        });
    </script>
@endpush
