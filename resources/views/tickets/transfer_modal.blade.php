...
--}}
{{-- Ticket Transfer To Modal Popup --}}
<div id="mdl-transfer" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div id="mdl_popup_loader"></div>
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <form id="frm-transfer" name="frm_transfer" method="post" action="#" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title">{{ trans("content.service_ticket_fields.Transfer_Ticket") }}</h3>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="department_id" id="department_id" class="form-control department_id"></select>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="problem_category_id" id="transfer_problem_category_id" class="form-control problem_category_id"></select>
                                </div>
                                <div class="amg-form-error-wrap"></div>
                            </div>
                        </div>
                    ...
                    <!-- Sub Category -->
                    <div class="row mb-0 mb-xl-3 px-4" id="transfer_sub_category_id_cvr">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="sub_category_id" id="transfer_sub_category_id" class="form-control sub_category_id"></select>
                                </div>
                                <div class="amg-form-error-wrap"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-xl-8">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="priority_id" id="transfer_priority_id" class="form-control priority_id" @if(!empty($action_controls) && $action_controls['ctrl_priority'] != 1) disabled @endif></select>
                                </div>
                                <div class="amg-form-error-wrap"></div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-0 mb-xl-3 px-4">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="tags" class="form-label b1-text me-2 mb-0 text-end">{{ trans("content.service_ticket_fields.tags") }}</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-tags"></i></span>
                                    <select name="tags[]" id="transfer_tags" class="form-control" multiple="multiple"></select>
                                </div>
                                <div class="amg-form-error-wrap"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="assigned_to" id="assigned_to" class="form-control assigned_to"></select>
                                </div>
                                <div class="amg-form-error-wrap">
                                    <label class="availabilityError"></label>
                        ...
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="transfer_device_id" id="device_id" class="form-control" placeholder="{{ trans('content.service_ticket_fields.Choose_Device') }}"></select>
                                </div>
                                <div class="amg-form-error-wrap"></div>
                            </div>
                        </div>
                    ...
                    <!-- Remarks -->
                    <div class="row mb-0 mb-xl-3 px-4" id="remarks_wrapper">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="remarks" class="form-label b1-text me-2 mb-0 text-end required">{{ trans("content.service_ticket_fields.reason_for_transfer_ticket") }}</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-chat-text"></i></span>
                                    <textarea name="remarks" id="remarks" class="form-control" placeholder="{{ trans('content.service_ticket_fields.enter_comments') }}" required></textarea>
                                </div>
                                <div class="amg-form-error-wrap">
                    ...
                    <!-- Internal Purpose Checkbox -->
                    <div class="row mb-0 mb-xl-3 px-4" id="is_note">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <div class="form-check">
                                    <input type="checkbox" id="is_note" name="is_note" value="1" checked="checked" class="form-check-input">
                                    <label for="is_note" class="form-check-label ms-2">{{ trans("content.service_ticket_fields.internal_purpose") }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Remove Tasks (hidden) -->
                    <div class="row mb-0 mb-xl-3 px-4 hide">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <div class="form-check">
