{{-- Change the ticket creator Modal Popup --}}
<div id="mdl-change-creator" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div id="mdl_popup_loader"></div>
    <div class="modal-dialog modal-dialog-centered" id="modal-parent">
        <form id="frm-change-creator" name="frm_change_creator" method="post" action="#" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title">{{ trans("content.service_ticket_fields.change_creator") ?? 'Change Creator' }}</h3>
                    ...
                    <div class="row mb-0 mb-xl-3 px-4">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="creator_id" class="form-label b1-text me-2 mb-0 text-end required">{{ trans("content.service_ticket_fields.Creator") }}</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-person"></i></span>
                                    <select name="creator_id" id="creator_id" class="form-control creator_id"></select>
                                </div>
                ...
                <div class="modal-footer">
                    <div class="amg-btn-group mt-3">
                        <button type="submit" id="btnSubmit" class="amg-btn amg-btn-primary">{{ trans("button.update") }}</button>
