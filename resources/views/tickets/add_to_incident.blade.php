...
{
  "page_no": "TKDIN04-26",
  "file": "add_to_incident.blade.php",
  "versions": [
    {
      "version": "1.0",
      ...
      "from": "2026-05",
      "reviewer": null,
      "description": "Initial Page Design"
    }
  ]
}
--}}
<div id="addincidentModal" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-5">
            <form name="incident-mdl-frm" id="addincident-mdl-frm" method="post" action="#" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                        ...
                        <div class="row g-4 px-4">
                            <div class="col-12">
                                <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                    <label for="incident" class="form-label b1-text me-2 mb-0 text-end required">{{ trans('content.service_ticket_fields.select_incident') }}</label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="bi bi-exclamation-triangle"></i></span>
                                        <select id="incident" name="incident" class="form-control"></select>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="amg-btn-group mt-3">
                            <button type="submit" id="btnSubmit" class="amg-btn amg-btn-primary">{{ trans("content.service_ticket_fields.ticket_incident") }}</button>
