...
{
  "page_no": "TKDAS05-26",
  "file": "assign_to_modal.blade.php",
  "versions": [
    {
      "version": "1.0",
...
--}}
{{-- Ticket Assign To Modal Popup --}}
<div id="mdl-assign-to" class="amg-modal amg-form-modal modal fade" data-bs-backdrop="static" data-bs-keyboard="false">
    <div id="mdl_popup_loader"></div>
    <div class="modal-dialog  modal-md modal-dialog-centered">
        <form id="frm-assign-to" name="frm_assign_to" method="post" action="#" class="form-horizontal w-100 amg-form-theme" enctype="multipart/form-data">
            ...
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center">
                    <h3 class="modal-title s1-text fw-semibold">{{ trans("content.service_ticket_fields.Transfer_Ticket") }}</h3>
                    ...
                    <div class="row mb-0 px-4">
                        <div class="col-12">
                            <div class="amg-form-field amg-form-field-row d-flex align-items-center">
                                <label for="assigned_to" class="form-label b1-text me-2 mb-0 text-end required">{{ trans("content.service_ticket_fields.Assign_To") }}</label>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="bi bi-person"></i></span>
                                    <select id="user_assigned_to" name="assigned_to" class="form-control"></select>
                                </div>
                ...
                <div class="amg-form-footer modal-footer">
                    <div class="amg-btn-group">
                        <button type="submit" id="btnSubmit" class="amg-btn amg-btn-primary">{{ trans("button.assign_to") }}</button>
