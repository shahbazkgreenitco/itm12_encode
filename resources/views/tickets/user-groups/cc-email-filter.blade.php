...
--}}
<div class="amg-modal amg-filter-modal modal fade show" id="ccEmailFilterModal" tabindex="-1" aria-hidden="true"
        ...
        <div class="modal-content rounded-5">
            ...
            <div class="modal-body">
                <div class="row g-3 px-4">
                    <div class="col-md-3">
                        <label class="form-label b5-text">{{ trans('content.filter_heading.filter_by_company') }}</label>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="filter_by_date" id="filter_by_date" class="form-select filter-input" autocomplete="off">
                            ...
                            <option value="1">{{ trans("content.filter_options.created_at") }}</option>
                            <option value="2">{{ trans("content.filter_options.updated_at") }}</option>
                        </select>
                    </div>
                    <div class="col-md-5">
                        <label
