...
{
  "page_no": "CCEMG-05",
  "file": "cc-email-filter.blade.php",
  "versions": [
    {
      "version": "1.0",
...
--}}
<div class="amg-modal amg-form-modal modal fade" id="cc-email-member-modal" tabindex="-1"
    aria-labelledby="ccEmailModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form id="cc-email-member-mdl-frm" name="ccEmailMemberMdlForm" method="post" action="#" en autocomplete="off"
            ...
            <div class="modal-content rounded-5">
                            ...
                            <div class="col-12 addMember">
                                <div class="amg-form-field d-flex align-items-center amg-form-field-row">
                                    <label class="form-label b1-text me-2 mb-0 text-end required"
                                        for="users">{{ trans('content.procurement_fields.Users') }}</label>
                                    <div class="input-group ">
                                        ...
                                        <select multiple name="users[]" id="users" class="form-select"
                                            placeholder="{{ trans('content.procurement_fields.select_user') }}"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 editMember">
                                <div class="amg-form-field d-flex align-items-center amg-form-field-row">
                                    <label class="form-label b1-text me-2 mb-0 text-end required"
                                        for="user">{{ trans('content.procurement_fields.Users') }}</label>
                                    <div class="input-group ">
                                        <span class="input-group-text" id="basic-addon1">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="amg-form-footer modal-footer d-flex justify-content-end py-4 border-top">
                    <button autocomplete="off" type="button" id="btnSubmit"
                        class="amg-btn amg-btn-primary amg-btn-md mb-2" style="width:150px">
                        {{ trans('button.save') }}
                    </button>

                    <button autocomplete="off" type="button" id="btnClear"
                        class="amg-btn amg-btn-secondary amg-btn-md mb-2 ms-2" data-bs-dismiss="modal"
                        style="width:150px">
                        {{ trans('button.close') }}
                    </button>
                </div>
