    ...
    <section class="content">
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            <div class="d-flex align-items-center gap-2">
                <svg onclick="window.location.href='{{ url('tickets/kanban-board/boards') }}'" width="25" height="21" viewBox="0 0 25 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <h3 class="h3-text mb-0" style="cursor: default;">Board Import - {{$boardName}}</h3>
            </div>
        </div>
                ...
                @if($success > 0)
                    <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon" role="alert">
                        ...
                        <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                            ...
                            {{ $success }} Record Successfully Imported.
                        </div>
                    </div>
                @endif
                ...
                <div class="import-wrapper">
                    <div class="row g-3 align-items-stretch">
                        <div class="col-12 col-sm-3">
                            ...
                            <form name="confirmForm" id="confirmForm" class="form-horizondal" method="post" action="" enctype="multipart/form-data" style="display:none;">
                                @csrf
                        ...
                        <div class="col-12 col-sm-9">
                            <div class="right-panel h-100">
                                <a class="amg-btn amg-btn-white amg-btn-md" href="{!! CommonHelper::asset('samples/KanbanBoardsImport.xlsx') !!}" target="_blank">
                        ...
                        <div class="instructions-card mt-1">
                            ...
                            <div class="ps-3 ps-sm-4">
                                ...
                                <div class="card-scroll-body" id="cardScrollBody">
                                    <ul class="ps-3">
                                        <li>
                                            <span class="b3-text me-3">{{ trans("kanban.download_format.name") }}<span class="mandatory"></span></span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.name_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.status") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.status_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.type") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.type_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.sprint") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.sprint_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.priority") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.priority_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.due_date") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.due_date_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.created_date") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.created_date_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.handlers") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.handlers_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.ticket_id") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.ticket_id_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.comment_note") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.comment_note_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.client_name") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.client_name_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.department_name") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.department_name_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.problem_category_name") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.problem_category_name_field") }}</span>
                                        </li>

                                        <li>
                                            <span class="b3-text">{{ trans("kanban.download_format.sub_category_name") }}</span>
                                            <span class="b5-text text-muted">{{ trans("kanban.download_format.sub_category_name_field") }}</span>
                                        </li>
                                    </ul>
                                </div>
