<div class="amg-modal modal fade" id="viewKanbanMdl" tabindex="-1"
    aria-hidden="true"
        ...
        <div class="modal-content rounded-5">
            ...
            <div class="modal-header d-flex align-items-center py-3 pt-4">
                ...
                <div class="ms-auto d-flex align-items-center gap-3">
                    ...
                    <!-- Expand / Collapse -->
                    <button class="btn btn-sm border-0 p-0 flex-shrink-0 active tiny-view-on" id="toggle_tiny_view" data-bs-toggle="tooltip" aria-label="Expand/Collapse" data-bs-original-title="Expand/Collapse">                        
            ...
            <div class="modal-body px-4 pb-4">
                ...
                <!-- Tab Bar -->
                <div class="tab-bar position-relative mb-4">

                    <ul class="nav nav-underline pe-5" id="kanbanTabs" role="tablist">
                        ...
                        <li class="nav-item border-0">
                            <button class="nav-link viewKanbanCardHistory"
                                id="history-tab"
                                data-bs-toggle="tab"
                                data-bs-target="#loadKanbanCardHistory"
                                type="button"
                                role="tab">
                                <span>History</span>
                            </button>
