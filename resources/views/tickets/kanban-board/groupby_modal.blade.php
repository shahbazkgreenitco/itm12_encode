<div class="amg-modal modal fade" id="groupbyModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">

    <div class="modal-dialog modal-md modal-dialog-centered">
        <form id="frm-groupbyModal" name="frm-groupbyModal">
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    ...
                    <input id="groupBy_id" type="hidden" name="groupBy_id">
                ...
                <div class="modal-body px-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <select id="groupby_date"
                                name="groupby_date"
                                class="form-control">

                                <option value="1">Created At</option>
                                <option value="2">Updated At</option>
                                <option value="3">Expected / Resolved Date</option>
                ...
                <div class="modal-footer justify-content-end pb-4 px-4">
                    ...
                    <div class="amg-btn-group gap-3">
                        ...
                        <button type="button"
                            id="btnClear"
                            class="amg-btn amg-btn-ghost bg-black text-white"
