<div class="amg-modal amg-form-modal modal modal-lg fade" id="mdl-history" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog">
        <form id="frm-history" class="form-horizontal w-100 amg-form-theme" autocomplete="off"
            ...
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body no-side-pad clearfix">
                    <div class="col-sm-12">
                        <div class="row mar-btm-6 no-bg" id="board_details"></div>
                        <div class="row mar-btm-6 timeline no-bg">
                            <div id="result"></div>
                        </div>
                    </div>
                </div>
