...
------------------------------------------------------------
Change Log:
[1.0.0] - Initial version  (SAFDAR ALI) - 2026-04-15 - #MANF-002
[1.0.1] - Updated file structure and fix the feedback points (SAFDAR ALI) - 2026-04-27 - #MANF-002
------------------------------------------------------------
*/
--}}
<div id="manufacturemd1" class="amg-modal amg-form-modal modal modal-lg fade user-mdl-box" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form id="Manufactureform" class="w-100 amg-form-theme" autocomplete="off">
            <div class="modal-content rounded-5">
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    <h3 class="modal-title s2-text fw-semibold px-2">{{ trans("config.manufacturer_fields.add_manufacturer") }}</h3>
                            ...
                            <div class="amg-form-field amg-form-field-row row mb-4">
                                <div class="col-2 text-md-start">
                                    <label class="form-label b1-text mb-2 required">{{
                                        trans("config.manufacturer_fields.name") }}</label>
                                </div>
                                <div class="col-10">
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M18 12H12M9 6.80273L12 12M12 12L9 17.1973" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M12 19C15.866 19 19 15.866 19 12C19 8.13401 15.866 5 12 5C8.13401 5 5 8.13401 5 12C5 15.866 8.13401 19 12 19Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 3"/>
                                                <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </span>
                                        <input type="text" name="name" id="name" class="form-control"
                                            placeholder="{{ trans('config.manufacturer_fields.manufacturer_name') }}">
                                    </div>
                                    <div class="amg-form-error-wrap" class="error"></div>
                                </div>
                            </div>
                                
                            <div class="amg-form-field amg-form-field-row row">
                                <div class="col-2 text-md-start">
                                    <label class="form-label b1-text mb-2">
                                        {{ trans("config.manufacturer_fields.attachment") }}
                                    </label>
                                </div>
                                ...
                                <div class="col-10">
                                    ...
                                    <small class="text-muted d-block mt-1 ms-5">
                                        (.jpg, .jpeg, .png)
                                        {{ trans("config.manufacturer_fields.max_size") }}
                                    </small>
                                </div>
                            </div>

                            <div class="col-md-12 attach_image d-none">
                                <div class="d-flex align-items-center gap-3">
                                    <i class="bi bi-trash del_attach text-danger cursor-pointer"
                                        title="Remove Image"></i>
                                    <img class="img_attach-class size-56 object-fit-contain" />
                                    <div class="img_name-class"></div>
                                </div>
                            </div>
                    </div>
                </div>
                <div class="amg-form-footer modal-footer justify-content-end py-4 px-4">
                    ...
                    <button type="button" class="amg-btn amg-btn-secondary s2-text bg-black text-white amg-btn-md"
                        data-bs-dismiss="modal">{{ trans("config.manufacturer_fields.cancel") }}</button>
                    <button type="button" id="btnSubmit" class="amg-btn s2-text amg-btn-primary amg-btn-md">{{
                        trans("config.manufacturer_fields.save") }}</button>
                </div>
            </div>
        </form>
    </div>
