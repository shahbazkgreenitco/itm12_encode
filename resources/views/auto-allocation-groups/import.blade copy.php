    ...
    <div class="header-actions-wrapper header-actions-white-wrapper d-flex align-items-center justify-content-between pe-4">
        <div class="py-3">
            <div class="container-fluid">
                ...
                <button onclick="location.href='{{ url('tickets/auto-allocation-groups') }}'"
            ...
            @if(isset($success) && $success)
                <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center gap-3">
                        Auto Allocation Groups Successfully Imported, Records Count(s): {{ $success }}
                    </div>
                    ...
                    <div class="col-12 col-sm-7">
                        <div class="right-panel h-100">
                            <a class="amg-btn amg-btn-white amg-btn-lg"
                                target="_blank"
                                href="{!! CommonHelper::asset('samples/AutoAllocationGroupsImportFormat.xlsx') !!}">

                                <span>
                                    {{ trans("auto-allocation-group.download_format") }}
                                </span>
                ...
                <div class="col-12 px-5">
                    ...
                    <div class="instructions-card mt-3">
                        ...
                        <h4 class="h4-text" style="color:#7F7F7F">
                            {{ trans("auto-allocation-group.header") }} :
                        </h4>
                        <div class="ps-3 ps-sm-4">
                            ...
                            <div class="card-scroll-body" id="cardScrollBody">
                                <ul class="ps-3">
                                    <li>
                                        <span class="s1-text me-3 required">
                                            {{ trans("auto-allocation-group.auto_allocation_group_company_name") }}
                                        </span>

                                        <span class="b1-text text-muted">
                                            {{ trans("auto-allocation-group.company_name_usr_field") }}
                                        </span>
                                    </li>

                                    <li>
                                        <span class="s1-text me-3 required">
                                            {{ trans("auto-allocation-group.auto_allocation_group_name") }}
                                        </span>

                                        <span class="b1-text text-muted">
                                            {{ trans("auto-allocation-group.auto_allocation_group_name_required") }}
                                        </span>
                                    </li>

                                    <li>
                                        <span class="s1-text me-3 required">
                                            {{ trans("auto-allocation-group.auto_allocation_group_desc") }}
                                        </span>

                                        <span class="b1-text text-muted">
                                            {{ trans("auto-allocation-group.auto_allocation_group_desc_required") }}
                                        </span>
                                    </li>

                                    <li>
                                        <span class="s1-text me-3 required">
                                            {{ trans("auto-allocation-group.auto_allocation_group_department_name") }}
                                        </span>

                                        <span class="b1-text text-muted">
                                            {{ trans("auto-allocation-group.auto_allocation_group_department_required") }}
                                        </span>
                                    </li>

                                    <li>
                                        <span class="s1-text me-3 required">
                                            {{ trans("auto-allocation-group.auto_allocation_group_approval_location") }}
                                        </span>

                                        <span class="b1-text text-muted">
                                            {{ trans("auto-allocation-group.auto_allocation_group_approval_location_required") }}
                                        </span>
                                    </li>

                                    <li>
                                        <span class="s1-text me-3">
                                            {{ trans("auto-allocation-group.auto_allocation_group_approval_location_for") }}
                                        </span>

                                        <span class="b1-text text-muted">
                                            {{ trans("auto-allocation-group.auto_allocation_group_approval_location_for_required") }}
                                        </span>
                                    </li>
                            ...
                            <a class="amg-btn amg-btn-link amg-btn-link-plain s1-text mt-2"
                                id="readMoreBtn">
