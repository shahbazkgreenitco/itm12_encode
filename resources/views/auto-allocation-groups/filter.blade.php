                ...
                <div class="row g-3 px-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="form-label b5-text"
                               for="filter_by_company">

                            {{ trans("auto-allocation-group.filter_by_company") }}

                        </label>

                        <select name="filter_by_company"
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="form-label b5-text"
                            ...
                            {{ trans("auto-allocation-group.filter_by_department") }}

                        </label>

                        <select name="filter_by_department[]"
                                id="filter_by_department"
                                class="form-select filter-input"
                                multiple>
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="form-label b5-text"
                               for="filter_by_location_access">

                            {{ trans("auto-allocation-group.filter_by_location_type") }}

                        </label>

                        <select name="filter_by_location_access"
                                id="filter_by_location_access"
                                class="form-select filter-input">

                            <option value=""></option>

                            <option value="1">
                                {{ trans("auto-allocation-group.current") }}
                            </option>

                            <option value="2">
                                {{ trans("auto-allocation-group.base") }}
                            </option>
            ...
            <div class="modal-footer justify-content-start mb-4 py-0">
                ...
                <div class="amg-btn-group mt-3 gap-3 px-4">
                    ...
                    <button type="button"
                        ...
                        {{ trans("auto-allocation-group.clear") }}
