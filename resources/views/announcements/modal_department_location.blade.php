{{-- * ------------------------------------------------------------
* File: modal_department_location.blade.php
...
* ------------------------------------------------------------ --}}
<div class="amg-modal modal fade" id="myModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 600px;">
        <div class="modal-content rounded-5">
            ...
            <div class="modal-header d-flex align-items-center py-3 pt-4">
                <h4 class="modal-title px-4">Details</h4>
            ...
            <!-- Body -->
            <div class="modal-body px-4" id="modalBodyContent"
                 style="max-height: 350px; overflow-y: auto;">
            </div>

            <!-- Footer -->
            <div class="modal-footer justify-content-start mb-3 px-4">
                <button type="button" class="amg-btn amg-btn-ghost bg-black text-white"
