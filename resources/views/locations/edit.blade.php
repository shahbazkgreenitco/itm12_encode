                ...
                <form method="post" class="form-horizontal" accept-charset="UTF-8" action="" autocomplete="off">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group  col-md-7">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" class="form-control"
                                            ...
                                            value="{{ count($errors) ? old('name') : $location->name }}">
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <div class="col-md-9">
                                        <select name="parent_id" id="" class="form-control">
                                            ...
                                            @foreach (App\Models\Location::where('id', '<>', $location->id)->get() as $loc)
                                                <option value="{{ $loc->id }}"
                                                    @if ($loc->id == (count($errors) ? old('parent_id') : $location->parent_id)) selected @endif>{{ $loc->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <select name="currency" id="" class="form-control">
                                            ...
                                            @foreach (App\Models\Currency::getCurrencies() as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if ($key == (count($errors) ? old('currency') : $location->currency)) selected @endif>
                            ...
                            <div class="row">
                                <div class="form-group col-md-7">
                                    <label for="address" class="control-label col-md-3 mandatory">Street 1</label>
                                    <div class="col-md-9">
                                        <input type="text" name="address" class="form-control" placeholder="Street 1"
                                            value="{{ count($errors) ? old('address') : $location->address }}">
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="address2" class="form-control" placeholder="Street 2"
                                            value="{{ count($errors) ? old('address2') : $location->address2 }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="city" class="form-control" placeholder="City"
                                            value="{{ count($errors) ? old('city') : $location->city }}">
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="state" class="form-control" placeholder="State"
                                            value="{{ count($errors) ? old('state') : $location->state }}">
                                        ...
                                        <select name="country" id="" class="form-control">
                                            ...
                                            @foreach ($location->getCountries() as $country)
                                                <option value="{{ $country->country_code }}"
                                                    @if ((count($errors) ? old('country') : $location->country) == $country->country_code) selected @endif>{{ $country->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group col-md-7">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="zip" class="form-control"
                                            ...
                                            value="{{ count($errors) ? old('zip') : $location->zip }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel-footer">
                            ...
                            <a class="btn btn-theme-black" href="{{ url('locations') }}">@lang('button.cancel')</a>
                        </div>
                    </div>
                </form>
            </div>
