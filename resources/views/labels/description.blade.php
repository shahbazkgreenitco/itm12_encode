...
<div id="remarksModal" class="amg-modal modal user-mdl-box relevant-ticket-mdl-box fade" tabindex="-1" role="dialog"
    data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content rounded-5">
            <div class="modal-header">
                <h3 class="modal-title px-4" id="locationModalLabel">
                    {{ trans('label.modal.description') }}
                </h3>
            ...
            <div class="modal-body">
                <div class="container-fluid py-3 px-4" id="text-data">
                </div>
            </div>
