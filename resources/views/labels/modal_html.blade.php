...
<div id="leasemd1" class="amg-modal modal fade user-mdl-box relevant-ticket-mdl-box" data-bs-backdrop="static"
    data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form id="leaseform" name="leaseform" method="post" action="#" class="form-horizontal amg-form-theme w-100"
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-header d-flex align-items-center py-3 px-4">
                    <h3 class="modal-title s2-text fw-semibold px-2" id="locationModalLabel">
                        {{ trans('label.modal.add_status_label') }}
                    </h3>
                ...
                <div class="modal-body">
                    <div class="container-fluid py-3">
                        <div class="row g-4">
                            <div class="col-md-6 amg-form-field amg-form-field-row d-inline">
                                <label class="form-label b1-text mb-2 required">
                                    {{ trans('label.modal.status_label') }}</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="status_label" class="form-control"
                                        placeholder="{{ trans('label.modal.placeholder_status_label') }}"
                                        data-required="Status label is required" required>
                                    <div class="field-error"></div>
                                </div>
                            </div>
                            <div class="col-md-6 amg-form-field amg-form-field-row d-inline">
                                <label class="form-label b1-text fw-bold mb-2">
                                    {{ trans('label.modal.status_type') }}
                                </label>
                                <div class="d-flex select-div">
                                    ...
                                    <select name="status_value" id="status_type" class="form-select">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12 amg-form-field amg-form-field-row d-inline">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea class="form-control textarea" name="notes" id="notes" placeholder="{{ trans('label.modal.notes') }}"></textarea>
                                    {{-- <input type="text" name="notes" id="notes" class="form-control"
                                        placeholder="{{ trans("label.modal.notes") }}"> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="amg-form-footer modal-footer justify-content-end py-4 px-4">
                    <div class="d-flex gap-2">
                        <button type="button" id="btnSubmit"
                            class="amg-btn amg-btn-primary s2-text amg-btn-block amg-btn-md">
                            {{ trans('label.modal.save') }}
                        </button>
                        <button type="button" id="btnClose" data-bs-dismiss="modal"
                            class="amg-btn amg-btn-secondary s2-text amg-btn-block amg-btn-md">
                            {{ trans('label.modal.close') }}
                        </button>
                    </div>
                </div>
            </div>
