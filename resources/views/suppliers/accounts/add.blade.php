...
<div class="amg-modal modal fade user-mdl-box device-mdl-box" id="addSupplierAccountModal" tabindex="-1" role="dialog"
    aria-labelledby="addSupplierAccountModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content rounded-5">
            <form method="post" id="AddSupplierAccountForm" autocomplete="off" accept-charset="UTF-8"
                enctype="multipart/form-data" class="w-100">
                @csrf
                <div class="modal-header">
                    <h3 class="modal-title px-4">{{ trans('suppliers.modal.add_new_account') }}</h3>
                        ...
                        <div class="row g-4 px-4">
                            ...
                            <div class="col-md-6 amg-form-field-row">
                                ...
                                <div class="d-flex select-div">
                                    ...
                                    <input type="text" autocomplete="off" name="bank_acc_number" id="bank_acc_number"
                                        class="form-control"
                            ...
                            <div class="col-md-6 amg-form-field-row">
                                ...
                                <div class="d-flex select-div">
                                    ...
                                    <input type="text" autocomplete="off" name="bank_acc_name" id="bank_acc_name"
                                        class="form-control"
                ...
                <div class="modal-footer justify-content-end mb-4 pb-4 py-0" style="padding-inline: 40px;">
                    <div class="d-flex gap-2">
                        <button type="button" id="btnAccountSubmit"
