...
<div class="amg-modal modal fade user-mdl-box device-mdl-box" id="addItemModal" tabindex="-1" role="dialog"
    aria-labelledby="addItemModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content rounded-5">
            <form id="addItemFrm" method="POST" class="form-horizontal w-100">
                <div class="modal-header">
                    <h3 class="modal-title px-4" id="modalTitle">
                        {{ trans('suppliers.modal.add_new_item') }}
                    </h3>
                ...
                <div class="modal-body mar-top">
                    <input type="hidden" autocomplete="off" name="item_type" id="item_type">
                    <div class="container-fluid py-3">
                        <div class="row g-4 px-4">
                            <div class="col-md-12 amg-form-field-row">
                                <label for="item_value" class="form-label b1-text mb-2" id="itemLabel">
                                    {{ trans('suppliers.modal.item_value') }}
                                ...
                                <div class="d-flex select-div">
                                    ...
                                    <input type="text" autocomplete="off" name="item_value" id="item_value"
                                        class="form-control"
                                        placeholder="{{ trans('suppliers.modal.item_value_placeholder') }}">
                                </div>
                                <div class="field-error">
                                    {!! $errors->first('item_value', '<label class="error"><i class="fa fa-times"></i> :message</label>') !!}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer justify-content-end mb-4 pb-4 py-0" style="padding-inline: 40px;">
                    <div class="d-flex gap-2">
                        <button type="button" id="btnSubmitItem"
