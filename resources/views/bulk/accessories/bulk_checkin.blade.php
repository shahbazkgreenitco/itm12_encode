...
@section('title', trans('content.accessory_fields.Bulk_Checkin'))
@section('content')
<style>
    :root {
        --primary: #1a2e5a;
        ...
        <div class="py-3">
            <div class="container-fluid">
                <button onclick="location.href='{{ url('accessories') }}'"
                    ...
                    <h2 class="h2-text mb-0">{{ trans('content.accessory_fields.Bulk_Checkin') }}</h2>
                </button>
            </div>
        </div>
    </div>
            ...
            <ul class="nav nav-underline" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="info-tab-link" data-bs-toggle="tab" href="#info-tab" role="tab">
                        <span>{{ trans('content.accessory_fields.Bulk_Checkin') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="check-out-info-tab-link" data-bs-toggle="tab" href="#check-out-info-tab"
                        role="tab">
                        <span>{{ trans('content.accessory_fields.Checkin_Information') }}</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-pane fade show active container-fluid pt-3 pb-5" id="info-tab">
                ...
                <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                        ...
                        {{ trans('accessories.accessory_checkin.import_success', ['count' => session('success',0)]) }}
                    </div>
                </div>
                @endif
                ...
                <div class="alert customize-alert alert-dismissible alert-light-danger bg-danger-subtle text-danger fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-start me-3 gap-3 me-md-0">
                        ...
                        <div>
                            ...
                            {{ trans('accessories.accessory_checkin.import_failed', ['count' => session('fail',0)]) }}
                ...
                <div class="alert customize-alert alert-dismissible alert-light-warning bg-warning-subtle text-warning fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                        ...
                        {{-- Purchase imported successfully --}}
                        {{ trans('accessories.accessory_checkin.import_default_success') }}
                    </div>
                </div>
                @endif
                        ...
                        <div class="col-12 col-sm-7">
                            <div class="right-panel h-100">
                                <a class="amg-btn amg-btn-white amg-btn-lg"
                                    href="{!! CommonHelper::asset('samples/AccessoryCheckInFormat.xlsx') !!}"
                                    target="_blank">
                                    ...
                                    <span class="font-weight-normal">{{
                                        trans('accessories.accessory_checkin.download_template') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 px-5">
                        ...
                        <div class="instructions-card mt-3">
                            ...
                            <h4 class="h4-text" style="color:#7F7F7F">
                                {{ trans("content.download_format.read_below_instructions") }}
                            </h4>
...
<script type="text/javascript" src="{!! CommonHelper::asset('js/bulk/accessories/bulk_checkin.js') !!}"></script>

<script>
    var config = {};
          config.bulk_checkin_info = "{{ url('accessories/bulk/checkin-info') }}";
        config.document_download = "{{ url('uploads/bulk_documents') }}";
        config.token = "{{ csrf_token() }}";
        config.translations = {
            press_enter_with_Search: '{{ trans('content.component_fields.press_enter_with_Search') }}',
			Reload:'{{ trans('content.component_fields.Reload') }}',
            Download_Document:'{{ trans('content.component_fields.Download_Document') }}',
