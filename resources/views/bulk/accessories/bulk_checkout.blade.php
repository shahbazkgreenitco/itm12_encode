...
@section('title', trans('content.accessory_fields.accessory_bulk_checkout'))
        ...
        <div class="py-3">
            <div class="container-fluid">
                <button onclick="location.href='{{ url('accessories') }}'"
                    ...
                    <h2 class="h2-text mb-0">{{ trans('content.accessory_fields.accessory_bulk_checkout') }}</h2>
                </button>
            </div>
        </div>
    </div>
            ...
            <ul class="nav nav-underline" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="info-tab-link" data-bs-toggle="tab" href="#info-tab" role="tab">
                        <span>{{ trans('content.accessory_fields.bulk_Checkout') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="check-out-info-tab-link" data-bs-toggle="tab" href="#check-out-info-tab"
                        role="tab">
                        <span>{{ trans('content.tab_header.checkOut_information') }}</span>
                    </a>
                </li>
            </ul>
        </div>
               ...
               @if(session('msg'))
                ...
                <div class="alert customize-alert alert-dismissible alert-light-success bg-success-subtle text-success fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                        ...
                        {{-- {{ session('success', 0) }} Purchase_imported_successfully --}}
                        {{ trans('accessories.accessory_checkout.import_success', ['count' => session('success',0)]) }}
                    </div>
                </div>
                @endif
                ...
                <div class="alert customize-alert alert-dismissible alert-light-danger bg-danger-subtle text-danger fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-start me-3 gap-3 me-md-0">
                        ...
                        <div>
                            ...
                            {{ trans('accessories.accessory_checkout.import_failed', ['count' => session('fail',0)]) }}
                ...
                <div class="alert customize-alert alert-dismissible alert-light-warning bg-warning-subtle text-warning fade show remove-close-icon"
                    ...
                    <div class="d-flex align-items-center me-3 gap-3 me-md-0">
                        ...
                        {{ trans('accessories.accessory_checkout.import_default_success') }}
                    </div>
                </div>
                @endif
                        ...
                        <div class="col-12 col-sm-7">
                            <div class="right-panel h-100">
                                <a class="amg-btn amg-btn-white amg-btn-lg"
                                    href="{!! CommonHelper::asset('samples/AccessoryCheckoutFormat.xlsx') !!}"
                                    target="_blank">
                                    ...
                                    <span class="font-weight-normal">{{
                                        trans('accessories.accessory_checkout.download_template') }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 px-5">
                        ...
                        <div class="instructions-card mt-3">
                            ...
                            <h4 class="h4-text" style="color:#7F7F7F">
                                {{ trans("content.download_format.data_sheet_validation") }}
                            </h4>
                            ...
                            <div class="ps-3 ps-sm-4">
                                ...
                                <div class="card-scroll-body" id="cardScrollBody">
                                    ...
                                    <ul class="ps-3">
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.download_format.batch_no_a") }}
                                                <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.download_format.batch_no_a_field") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text">{{ trans("content.download_format.assigned_for") }}
                                            </span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.download_format.assigned_for_text") }}</span>
                                        </li>
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.download_format.assigned_to") }}
                                                <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.download_format.assigned_to_a_field") }}</span>
                                        </li>
                                        @if(in_array(config('app.client'), ["knightfrank"]))
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.download_format.notes_usr_up")
                                                }} <span class="mandatory"></span></span>
                                            <span class="b1-text text-muted">{{
                                                trans("content.download_format.notes") }}</span>
                                        </li>
                                         @else
                                        <li>
                                            <span class="s1-text me-3">{{ trans("content.download_format.notes_usr_up")
                                            ...
                                            <span class="b1-text text-muted">{{
                                                trans("content.download_format.notes_usr_up_field") }}</span>
                                        </li>
                                         @endif
                            ...
                            <h4 class="h4-text" style="color:#7F7F7F">
                                {{ trans('content.download_format.never_change') }}. <strong>{{ trans("content.download_format.date_values") }}</strong>  </h4>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="{!! CommonHelper::asset('js/bulk/accessories/bulk_checkout.js') !!}"></script>

<script>
    var config = {};
     config.bulk_checkout_info = "{{ url('accessories/bulk/checkout-info') }}";
        ...
        config.translations = {
            ...
            Download_Document: '{{ trans('content.accessory_fields.Download_Document') }}',
            Reload: '{{ trans('content.accessory_fields.Reload') }}',
            ...
            please_choose_file: '{{ trans('content.accessory_fields.please_choose_file') }}',
            Choose_file_for_checkout: '{{ trans('content.accessory_fields.Choose_file_for_checkout') }}',
            please_upload_valid_xlsx:'{{ trans('content.accessory_fields.please_upload_valid_xlsx') }}',
        };
