...
<section class="content" id="main-user-list-wrapper">
        ...
        <div class="header-actions-wrapper d-flex align-items-center justify-content-between pe-4">
            ...
            <div class="d-flex gap-8">
                ...
                <button class="header-icon-btn header-icon-btn-sm btn-open-filter" type="button"
                    ...
                    <span class="b3-text opacity-50">{{ trans('licenses.license_fields.filter') }}</span>
                    <span class="filter-count-badge d-none" aria-label="Active filters">0</span>
                </button>

                {{-- Download Excel --}}
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-license-export" type="button"
                    data-bs-toggle="tooltip" title="{{ trans('licenses.license_fields.download') }}">
                ...
                {{-- Download pdf --}}
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-export-license-pdf" type="button"
                    data-bs-toggle="tooltip" title="{{ trans('licenses.license_fields.download_pdf') }}">
                ...
                {{-- Bulk Import --}}
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-import-license" type="button"
                    data-bs-toggle="tooltip" title="{{ trans('licenses.license_fields.license_import') }}">
                ...
                {{-- Show Deleted --}}
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-show-license" type="button"
                    data-bs-toggle="tooltip" title="{{ trans('licenses.license_fields.show_deleted_licenses') }}">
                ...
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-show-license non-deleted-icon d-none"
                    type="button" data-bs-toggle="tooltip"
                    title="{{ trans('licenses.license_fields.show_non_deleted_license') }}">
                ...
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-checkin btn-bulk-checkin" type="button"
                    data-bs-toggle="tooltip" title="{{trans('licenses.license_fields.bulk_checkin') }}">
                ...
                <button class="header-icon-btn-only header-icon-btn-only-sm btn-checkout btn-bulk-checkout"
                    type="button" data-bs-toggle="tooltip" title="{{trans('licenses.license_fields.bulk_checkout') }}">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                        <path
                ...
                {{-- Add accessory --}}
                <button class="amg-btn amg-btn-primary amg-btn-sm btn-add-license" type="button"
                    data-bs-toggle="tooltip" title="{{trans('licenses.license_fields.add_license') }}">
                    ...
                    <span>{{ trans('licenses.license_fields.add_license') }}</span>
                </button>
            </div>
        </div>
    </div>
            ...
            <div class="card rounded-0">
                <div class="card-body pt-3">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <div class="col-auto">
                            <select
                                class="amg-table-pagination-dropdown userModulePageLenth licenseModulePageLenth license-list-page-length">
                                <option value="10" selected>{{ trans('licenses.license_fields.show') }} (10)</option>
                                <option value="25">{{ trans('licenses.license_fields.show') }} (25)</option>
                                <option value="50">{{ trans('licenses.license_fields.show') }} (50)</option>
                                <option value="100">{{ trans('licenses.license_fields.show') }} (100)</option>
                            </select>
                        </div>
                        ...
                        <div>
                            <div class="amg-list-searchbar">
                                <svg class="amg-list-searchbar__icon btn-searchbox" width="18" height="18"
                                ...
                                <input type="text" class="amg-list-searchbar__input license-list-search"
                                    placeholder="{{ trans('licenses.license_fields.search') }}...">
                            </div>
                        </div>
                        ...
                        <button class="amg-refresh-btn btn-reload-list">
                            ...
                            <span>{{ trans('licenses.license_fields.refresh_list') }}</span>
                        </button>
                    </div>

                    <div class="js-license-list-view-panel">
                        <div class="table-responsive">
                            <table id="mytable" class="table display app-data-table">
                                <thead>
                                    <tr>
                                        <th>
                                            <h4><input class="form-check-input" type="checkbox" value=""
                                                    id="select-all"></h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.license") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.seats") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.avail") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.network_count") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.expire_date") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.purchase_date") }}/</h4>
                                            <h4>{{ trans("licenses.license_fields.cost") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.location") }}/</h4>
                                            <h4>{{ trans("licenses.license_fields.department") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.order_number") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.updated_on") }}</h4>
                                        </th>
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.compliance_status") }}</h4>
                                        </th>
                                        {{-- <th>
                                            <h4>{{ trans("licenses.license_fields.check_all_versions") }}</h4>
                                        </th> --}}
                                        <th>
                                            <h4>{{ trans("licenses.license_fields.action") }}</h4>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
    ...
    @include('licenses.license-modal')
    @include('licenses.checkout_modal')
    @include('licenses.filter')
</section>
@endsection
...
@push('scripts')
<script type="text/javascript" src="{!! CommonHelper::asset('js/licenses/AddEdit.js') !!}"></script>
<script type="text/javascript" src="{!! CommonHelper::asset('js/licenses/index.js') !!}"></script>
<script type="text/javascript">
    $(document).ready(function () {
        var config = new Object;
        config.url = new Object;
        config.assigned_to_dept = "{{ isset($_GET['assigned_to_dept']) ? $_GET['assigned_to_dept'] : '' }}";
        config.location_filter = "{{ $location }}";
        config.department_filter = "{{ $department }}";
        config.url.licenses = "{{ url('jx-licenses') }}";
        config.url.add = "{{ url('license/add') }}";
        config.url.edit = "{{ url('license/edit') }}";
        config.url.delete = "{{ url('license/delete') }}";
        config.url.update = "{{ url('license/update') }}";
        ...
        config.url.restore = "{{ url('licenses-restore') }}";
        config.default_currency_format = "{{ CommonHelper::settings()->default_currency }}";
        config.getVersionBySoftwares = "{{ url('getVersionBySoftwares') }}";
        config.getSoftwareByAjax = "{{ url('getSoftwareByAjax') }}";
        config.imgviewpath = "{{ url('uploads/license') }}";
        config.url.download_url = "{{ url('export-licenses') }}";
        config.ajaxGetInternalPlace = "{{url('ajaxGetInternalPlace')}}";
        config.url.getSupplierByAjax = "{{ url('getSupplierByAjax') }}";
        config.url.getManufacturerByAjax = "{{ url('getManufacturerByQuery') }}";
        ...
        config.url.getDepreciationOptions = "{{ url('getDepreciationOptions') }}"
        config.url.getCategoryByAjax = "{{ url('getCategoryOptions') }}";
        config.url.getCurrencyOptions = "{{ url('/currencies/options') }}";
        config.url.getCompanyOptions = "{{ url('getcompanyoptions') }}";
        config.url.deatil = "{{ url('license/detail') }}";
        config.url.download_url_pdf = "{{ url('export-licenses-pdf') }}";
        config.translations = {
            edit_licenses: '{{trans('licenses.license_fields.edit_licenses')}}',
            add_licenses: '{{trans('licenses.license_fields.add_license')}}',
            delete_licenses: '{{ trans('licenses.license_fields.delete_licenses') }}',
            something_went_wrong: '{{ trans('licenses.license_fields.something_went_wrong') }}',
            are_you_want_delete: '{{ trans('licenses.license_fields.are_you_want_delete') }}',
            select_company: '{{ trans('licenses.license_fields.select_company') }}',
            Select_the_manufacturer: '{{ trans('licenses.license_fields.Select_the_manufacturer') }}',
            Select_the_Location: '{{ trans('licenses.license_fields.Select_the_location') }}',
            select_internal_place: '{{ trans('licenses.license_fields.select_internal_place') }}',
            Select_Category: '{{ trans('licenses.license_fields.Select_Category') }}',
            Select_the_Supplier: '{{ trans('licenses.license_fields.Select_the_Supplier') }}',
            Select_the_Purchase_Invoice: '{{ trans('licenses.license_fields.Select_the_Purchase_Invoice') }}',
            Select_Currency_Format: '{{ trans('licenses.license_fields.Select_Currency_Format') }}',
            Select_Depreciation: '{{ trans('licenses.license_fields.Select_Depreciation') }}',
            please_enter_valid_search: '{{ trans('licenses.license_fields.please_enter_valid_search') }}',
            placeholder_no_filter: '{{ trans('licenses.filter_heading.no_filter') }}',
            restore_licenses: '{{ trans('licenses.license_fields.restore_licenses')}}',
            are_you_restore: '{{ trans('licenses.license_fields.are_you_restore')}}',
            serial_number: '{{ trans('licenses.license_fields.serial_number')}}',
            unique_tag: '{{ trans('licenses.license_fields.unique_tag')}}',
            license_name: '{{ trans('licenses.license_fields.license_name')}}',
            agreement_no: '{{ trans('licenses.license_fields.agreement_no')}}',
            company_name: '{{ trans('licenses.license_fields.company_name')}}',
            category: '{{ trans('licenses.license_fields.category')}}',
            batch_number: '{{ trans('licenses.license_fields.batch_number')}}',
            location: '{{ trans('licenses.license_fields.location')}}',
            department: '{{ trans('licenses.license_fields.department')}}',
            internal_place: '{{ trans('licenses.license_fields.internal_place')}}',
            ...
            agreement_number: '{{ trans('licenses.license_fields.agreement_number') }}',
        }
...
<style>
    ...
    #license-checkout-mdl .select2-container {
        width: 100% !important;
    }
