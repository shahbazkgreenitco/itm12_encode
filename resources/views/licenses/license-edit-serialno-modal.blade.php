<div id="license-expected-checkin-date" class="amg-modal modal fade user-mdl-box" data-bs-backdrop="static"
    data-bs-keyboard="false">

    <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;">

        <form id="license-expected-checkin-date-frm" name="licenseExpectedCheckinDateForm" method="post"
            autocomplete="off">
            ...
            <div class="modal-content rounded-5">
                ...
                <div class="modal-header d-flex align-items-center py-3 pt-4">
                    ...
                    <h3 class="modal-title px-4">
                        {{ trans("licenses.license_seats_edit_serail.expected_checkin_date") }}
                    </h3>
                        ...
                        <div class="row g-4 px-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="form-label b1-text fw-bold mb-2">
                                    {{ trans("licenses.license_seats_edit_serail.license_serial") }}
                                </label>
                                 <input type="text" autocomplete="off" name="serial" id="license_serial"
                                        class="form-control"
                                        placeholder="{{ trans("licenses.license_seats_edit_serail.license_serial") }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" autocomplete="off" name="expected_checkin" id="expected_checkin"
                                        class="form-control"
                                        placeholder="{{ trans("licenses.license_seats_edit_serail.choose_date") }}">
                ...
                <div class="modal-footer justify-content-end mb-4 pb-4 py-0 px-4">
                    ...
                    <button type="button" id="btnSubmit" class="amg-btn amg-btn-primary amg-btn-md">
                        ...
                        {{ trans("licenses.license_seats_edit_serail.save") }}
                    ...
                    <button type="button" id="btnClear" class="amg-btn amg-btn-outline-secondary amg-btn-md"
                        ...
                        {{ trans("licenses.license_seats_edit_serail.close") }}
