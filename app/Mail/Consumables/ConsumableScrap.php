...
class ConsumableScrap extends Mailable implements ShouldQueue
{
    ...
    public function content()
    {
        ...
        $view = match ($client_name) {
            'tscpl' => 'mail.clients.tbsl.consumableScrap',
            default => 'mail.consumables.consumableScrap',
        };
